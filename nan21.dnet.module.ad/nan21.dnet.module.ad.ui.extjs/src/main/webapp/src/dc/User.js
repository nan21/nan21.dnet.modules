...
net.nan21.dnet.module.ad.usr.dc.User$List = Ext.extend(dnet.base.AbstractDcvGrid, {
	...
	,_defineColumns_: function () {	
		...
		.addTextColumn({ name:"accountType", dataIndex:"accountType",width:100 })   	
...
net.nan21.dnet.module.ad.usr.dc.User$Edit = Ext.extend(dnet.base.AbstractDcvForm, {
	_defineElements_: function () {	
		...
		.addCombo({ name:"accountType", xtype:"combo", dataIndex:"accountType",anchor:"-20",allowBlank:false,store:[ "Employee"]  })
