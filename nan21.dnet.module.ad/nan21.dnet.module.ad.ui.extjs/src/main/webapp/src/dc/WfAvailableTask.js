...
net.nan21.dnet.module.ad.workflow.dc.WfAvailableTask = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"WfAvailableTask" 		 
			,ds: new net.nan21.dnet.module.ad.workflow.ds.WfAvailableTaskDs()			  
		});
	 	net.nan21.dnet.module.ad.workflow.dc.WfAvailableTask.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.ad.workflow.dc'); 
net.nan21.dnet.module.ad.workflow.dc.WfAvailableTask$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.ad.workflow.dc.WfAvailableTask$Filter", net.nan21.dnet.module.ad.workflow.dc.WfAvailableTask$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.ad.workflow.dc');	 	 
net.nan21.dnet.module.ad.workflow.dc.WfAvailableTask$List = Ext.extend(dnet.base.AbstractDcvGrid, {
...
Ext.reg("net.nan21.dnet.module.ad.workflow.dc.WfAvailableTask$List", net.nan21.dnet.module.ad.workflow.dc.WfAvailableTask$List ); 
