...
net.nan21.dnet.module.ad.workflow.dc.WfMyTask = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"WfMyTask" 		 
			,ds: new net.nan21.dnet.module.ad.workflow.ds.WfMyTaskDs()			  
		});
	 	net.nan21.dnet.module.ad.workflow.dc.WfMyTask.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.ad.workflow.dc'); 
net.nan21.dnet.module.ad.workflow.dc.WfMyTask$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.ad.workflow.dc.WfMyTask$Filter", net.nan21.dnet.module.ad.workflow.dc.WfMyTask$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.ad.workflow.dc');	 	 
net.nan21.dnet.module.ad.workflow.dc.WfMyTask$List = Ext.extend(dnet.base.AbstractDcvGrid, {
...
Ext.reg("net.nan21.dnet.module.ad.workflow.dc.WfMyTask$List", net.nan21.dnet.module.ad.workflow.dc.WfMyTask$List ); 
