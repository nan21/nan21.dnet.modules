...
net.nan21.dnet.module.ad.usr.dc.UserGroup = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"UserGroup" 		 
			,ds: new net.nan21.dnet.module.ad.usr.ds.UserGroupDs()			  
		});
	 	net.nan21.dnet.module.ad.usr.dc.UserGroup.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.ad.usr.dc'); 
net.nan21.dnet.module.ad.usr.dc.UserGroup$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.ad.usr.dc.UserGroup$Filter", net.nan21.dnet.module.ad.usr.dc.UserGroup$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.ad.usr.dc');	 	 
net.nan21.dnet.module.ad.usr.dc.UserGroup$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
...
Ext.reg("net.nan21.dnet.module.ad.usr.dc.UserGroup$EditList", net.nan21.dnet.module.ad.usr.dc.UserGroup$EditList ); 
