...
net.nan21.dnet.module.ad.usr.dc.Role = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"Role" 		 
			,ds: new net.nan21.dnet.module.ad.usr.ds.RoleDs()			  
		});
	 	net.nan21.dnet.module.ad.usr.dc.Role.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.ad.usr.dc'); 
net.nan21.dnet.module.ad.usr.dc.Role$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.ad.usr.dc.Role$Filter", net.nan21.dnet.module.ad.usr.dc.Role$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.ad.usr.dc');	 	 
net.nan21.dnet.module.ad.usr.dc.Role$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
...
Ext.reg("net.nan21.dnet.module.ad.usr.dc.Role$EditList", net.nan21.dnet.module.ad.usr.dc.Role$EditList ); 
