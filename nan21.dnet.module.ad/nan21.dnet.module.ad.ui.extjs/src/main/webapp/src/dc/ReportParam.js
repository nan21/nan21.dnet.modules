...
Ext.define("net.nan21.dnet.module.ad.report.dc.ReportParam$CtxEditList", {
	...
	_defineColumns_: function () {
		...
		.addTextColumn({ name:"listOfValues", dataIndex:"listOfValues", width:100,editor:{xtype:"textfield", selectOnFocus:true } })
		.addTextColumn({ name:"defaultValue", dataIndex:"defaultValue", width:100,editor:{xtype:"textfield", selectOnFocus:true } })
