...
net.nan21.dnet.module.ad.report.dc.ReportParam = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"ReportParam" 		 
			,ds: new net.nan21.dnet.module.ad.report.ds.ReportParamDs()			  
		});
	 	net.nan21.dnet.module.ad.report.dc.ReportParam.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.ad.report.dc');	 	 
net.nan21.dnet.module.ad.report.dc.ReportParam$CtxEditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
...
Ext.reg("net.nan21.dnet.module.ad.report.dc.ReportParam$CtxEditList", net.nan21.dnet.module.ad.report.dc.ReportParam$CtxEditList ); 
