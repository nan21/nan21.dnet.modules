...
net.nan21.dnet.module.ad.usr.dc.UserType = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"UserType" 		 
			,ds: new net.nan21.dnet.module.ad.usr.ds.UserTypeDs()			  
		});
	 	net.nan21.dnet.module.ad.usr.dc.UserType.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.ad.usr.dc'); 
net.nan21.dnet.module.ad.usr.dc.UserType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.ns('net.nan21.dnet.module.ad.usr.dc');	 	 
net.nan21.dnet.module.ad.usr.dc.UserType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.ad.usr.dc.UserType$EditList", net.nan21.dnet.module.ad.usr.dc.UserType$EditList ); 
