...
Ext.define("net.nan21.dnet.module.ad.impex.dc.CsvExportField$CtxEditList", {
	...
	,_defineColumns_: function () {
		...
		.addNumberColumn({ name:"sequenceNo", dataIndex:"sequenceNo", align:"right",format:Ext.NUMBER_FORMAT_INT, width:60,editor:{xtype:"numberfield", selectOnFocus:true ,decimalPrecision:2 } })
