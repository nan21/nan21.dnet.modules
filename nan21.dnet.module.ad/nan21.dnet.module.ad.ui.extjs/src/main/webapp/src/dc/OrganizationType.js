...
net.nan21.dnet.module.ad.org.dc.OrganizationType = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"OrganizationType" 		 
			,ds: new net.nan21.dnet.module.ad.org.ds.OrganizationTypeDs()			  
		});
	 	net.nan21.dnet.module.ad.org.dc.OrganizationType.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.ad.org.dc'); 
net.nan21.dnet.module.ad.org.dc.OrganizationType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.ad.org.dc.OrganizationType$Filter", net.nan21.dnet.module.ad.org.dc.OrganizationType$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.ad.org.dc');	 	 
net.nan21.dnet.module.ad.org.dc.OrganizationType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	...
	,_defineColumns_: function () {		
		...
		this._columns_.add("virtualEntity", { xtype:"booleancolumn", dataIndex:"virtualEntity", sortable:true, hidden:false, trueText:Dnet.translate("msg", "bool_true"), falseText:Dnet.translate("msg", "bool_false"),editor: {xtype: 'combo', mode: 'local', selectOnFocus:true, valueField: 'bv', displayField: 'tv', store:new Ext.data.ArrayStore({idIndex:0,fields: [ 'bv', 'tv' ], data: [[true,Dnet.translate("msg", "bool_true")],[false,Dnet.translate("msg", "bool_false")]] }), triggerAction:'all', forceSelection:true }});
		this._columns_.add("legalEntity", { xtype:"booleancolumn", dataIndex:"legalEntity", sortable:true, hidden:false, trueText:Dnet.translate("msg", "bool_true"), falseText:Dnet.translate("msg", "bool_false"),editor: {xtype: 'combo', mode: 'local', selectOnFocus:true, valueField: 'bv', displayField: 'tv', store:new Ext.data.ArrayStore({idIndex:0,fields: [ 'bv', 'tv' ], data: [[true,Dnet.translate("msg", "bool_true")],[false,Dnet.translate("msg", "bool_false")]] }), triggerAction:'all', forceSelection:true }});
		this._columns_.add("accountingEnabled", { xtype:"booleancolumn", dataIndex:"accountingEnabled", sortable:true, hidden:false, trueText:Dnet.translate("msg", "bool_true"), falseText:Dnet.translate("msg", "bool_false"),editor: {xtype: 'combo', mode: 'local', selectOnFocus:true, valueField: 'bv', displayField: 'tv', store:new Ext.data.ArrayStore({idIndex:0,fields: [ 'bv', 'tv' ], data: [[true,Dnet.translate("msg", "bool_true")],[false,Dnet.translate("msg", "bool_false")]] }), triggerAction:'all', forceSelection:true }});
...
Ext.reg("net.nan21.dnet.module.ad.org.dc.OrganizationType$EditList", net.nan21.dnet.module.ad.org.dc.OrganizationType$EditList ); 
