...
Ext.define("net.nan21.dnet.module.ad.data.dc.AttachmentType$EditList", {
	...
	_defineColumns_: function () {
		...
		.addTextColumn({ name:"useInContext", dataIndex:"useInContext",width:200,editor:{xtype:"textfield", selectOnFocus:true ,maxLength:255} })
		...
		.addTextColumn({ name:"uploadPath", dataIndex:"uploadPath",width:200,editor:{xtype:"textfield", selectOnFocus:true ,maxLength:400} })
		.addTextColumn({ name:"baseUrl", dataIndex:"baseUrl",width:100,editor:{xtype:"textfield", selectOnFocus:true ,maxLength:255} })
