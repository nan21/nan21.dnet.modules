...
Ext.define("net.nan21.dnet.module.ad.data.dc.AttachmentType$Filter", {
	...
	_defineElements_: function () {	
		...
		.addCombo({ name:"useInContext", xtype:"combo", dataIndex:"useInContext",anchor:"-20",store:[ "BusinessPartner.company", "BusinessPartner.person", "Product", "Employee", "ProjectIssue"]  })
		//containers
...
Ext.define("net.nan21.dnet.module.ad.data.dc.AttachmentType$EditList", {
	...
	,_defineColumns_: function () {
		...
		.addComboColumn({ name:"useInContext", dataIndex:"useInContext", trueText:Dnet.translate("msg", "bool_true"), falseText:Dnet.translate("msg", "bool_false"),editor: {xtype: 'combo', mode: 'local', selectOnFocus:true, valueField: 'bv', displayField: 'tv' ,store:[ "BusinessPartner.company", "BusinessPartner.person", "Product", "Employee", "ProjectIssue"] , triggerAction:'all', forceSelection:true }})
