...
Ext.define("net.nan21.dnet.module.ad.data.dc.AttachmentType$EditList", {
	...
	,_defineColumns_: function () {
		...
		.addComboColumn({ name:"useInContext", dataIndex:"useInContext", trueText:Dnet.translate("msg", "bool_true"), falseText:Dnet.translate("msg", "bool_false"),editor: {xtype: 'combo', mode: 'local', selectOnFocus:true, valueField: 'bv', displayField: 'tv' ,store:[ "BusinessPartner.company", "BusinessPartner.person", "Product", "Employee"] , triggerAction:'all', forceSelection:true }})
