...
Ext.define("net.nan21.dnet.module.ad.workflow.dc.ActTaskInstanceHistory$Filter", {
	...
	_defineElements_: function () {	
		...
		.addTextField({ name:"processDefinitionId", dataIndex:"processDefinitionId",anchor:"-20",maxLength:64  })
		.addTextField({ name:"taskDefinitionKey", dataIndex:"taskDefinitionKey",anchor:"-20",maxLength:255  })
		.addTextField({ name:"processInstanceId", dataIndex:"processInstanceId",anchor:"-20",maxLength:64  })
