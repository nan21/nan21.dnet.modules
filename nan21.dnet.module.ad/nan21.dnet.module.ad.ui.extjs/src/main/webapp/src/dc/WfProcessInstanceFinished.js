...
net.nan21.dnet.module.ad.workflow.dc.WfProcessInstanceFinished = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"WfProcessInstanceFinished" 		 
			,ds: new net.nan21.dnet.module.ad.workflow.ds.WfProcessInstanceFinishedDs()			  
		});
	 	net.nan21.dnet.module.ad.workflow.dc.WfProcessInstanceFinished.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.ad.workflow.dc'); 
net.nan21.dnet.module.ad.workflow.dc.WfProcessInstanceFinished$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.ad.workflow.dc.WfProcessInstanceFinished$List", net.nan21.dnet.module.ad.workflow.dc.WfProcessInstanceFinished$List ); 
