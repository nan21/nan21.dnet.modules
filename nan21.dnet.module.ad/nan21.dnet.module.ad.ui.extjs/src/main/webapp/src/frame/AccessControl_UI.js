...
Ext.define("net.nan21.dnet.module.ad.usr.frame.AccessControl_UI", {  
	...
	,_defineDcs_: function() {	
		...
		.linkDc("dsMtdAccess", "ctrl",{fetchMode:"auto",fields:[ {childField:"accessControlId", parentField:"id"} ]} );		
	}	 
	...
	,_defineElements_: function() {							
		...
		.addDcView("dsMtdAccess",{ name:"dsMtdAccessCtxEditList", xtype:"net.nan21.dnet.module.ad.usr.dc.DsMethodAccessControl$CtxEditList", frame:true,title:"Methods"})	 
