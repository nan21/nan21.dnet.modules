...
Ext.define("net.nan21.dnet.module.ad.impex.frame.ExportMap_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcView("item",{ name:"itemCtxEditList", xtype:"net.nan21.dnet.module.ad.impex.dc.ExportMapItem$CtxEditList", frame:true})	 
...
;	 	
	...
	,_defineToolbars_: function() {
		this._getBuilder_()
			...
			.beginToolbar("tlbItemCtxEditList", {dc:"item"}).addQuery().addSave().addNew().addCopy().addDeleteSelected().addCancel().addSeparator().addAutoLoad().end(); 	
	}
