...
Ext.define("net.nan21.dnet.module.ad.system.frame.SysDateFormat_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("fmt",{ name:"fmtFilter", xtype:"net.nan21.dnet.module.ad.system.dc.SysDateFormat$Filter"})	 
...
;	 	
	...
	,_defineToolbars_: function() {
		this._getBuilder_()
			.beginToolbar("tlbFmtEditList", {dc:"fmt"}).addQuery().addSave().addNew().addCopy().addDeleteSelected().addCancel().end(); 	
	}
