...
Ext.define("net.nan21.dnet.module.ad.system.frame.SysDateFormat_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("fmt",{ name:"fmtFilter", xtype:"net.nan21.dnet.module.ad.system.dc.SysDateFormat$Filter",height:80})	 
		.addDcEditGridView("fmt",{ name:"fmtEditList", xtype:"net.nan21.dnet.module.ad.system.dc.SysDateFormat$EditList", frame:true})	 
...
;	 	
	...
	,_defineToolbars_: function() {
		this._getBuilder_()
			.beginToolbar("tlbFmtEditList", {dc:"fmt"}).addQuery().addSave().addNew().addCopy().addDeleteSelected().addCancel().addReports().addSeparator().addSeparator().addTitle({"text":"Date formats"}).end(); 	
	}
