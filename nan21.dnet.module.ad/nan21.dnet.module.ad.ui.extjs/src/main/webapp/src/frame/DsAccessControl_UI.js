...
Ext.define("net.nan21.dnet.module.ad.usr.frame.DsAccessControl_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcEditGridView("dsAccess",{ name:"dsAccessEditList", xtype:"net.nan21.dnet.module.ad.usr.dc.DsAccessControl$EditList", frame:true})	 
...
;	 	
	...
	,_defineToolbars_: function() {
		this._getBuilder_()
			.beginToolbar("tlbDsAccessEditList", {dc:"dsAccess"}).addQuery().addSave().addNew().addCopy().addDeleteSelected().addCancel().addReports().addSeparator().addSeparator().addTitle({"text":"DS rules"}).end(); 	
	}
