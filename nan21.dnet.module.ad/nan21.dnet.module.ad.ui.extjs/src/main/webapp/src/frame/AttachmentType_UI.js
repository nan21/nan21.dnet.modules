...
Ext.define("net.nan21.dnet.module.ad.data.frame.AttachmentType_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcEditGridView("attchType",{ name:"attchTypeEditList", xtype:"net.nan21.dnet.module.ad.data.dc.AttachmentType$EditList", frame:true})	 
...
;	 	
	...
	,_defineToolbars_: function() {
		this._getBuilder_()
			.beginToolbar("tlbAttchTypeEditList", {dc:"attchType"}).addQuery().addSave().addNew().addCopy().addDeleteSelected().addCancel().addReports().addSeparator().addSeparator().addTitle({"text":"Attachment types"}).end(); 	
	}
