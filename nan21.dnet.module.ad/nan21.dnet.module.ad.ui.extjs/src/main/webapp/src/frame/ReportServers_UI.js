...
net.nan21.dnet.module.ad.report.frame.ReportServers_UI = Ext.extend( dnet.base.AbstractUi, {  
	...
	,_defineDcs_: function () {	
		var  m = new net.nan21.dnet.module.ad.report.dc.ReportServer({multiEdit:false});	 	
	...
	,_defineElements_: function () {
		this._elems_.add("mFilter", { xtype:"net.nan21.dnet.module.ad.report.dc.ReportServer$Filter", id:Ext.id(), _controller_:this._dcs_.get("m") ,listeners:{ activate:{scope:this,fn:function(){this.doLayout(false,true);} } } });	
		this._elems_.add("mEditList", { xtype:"net.nan21.dnet.module.ad.report.dc.ReportServer$EditList", frame:true, id:Ext.id(), _controller_:this._dcs_.get("m") ,listeners:{ activate:{scope:this,fn:function(){this.doLayout(false,true);} } } });	
	...
	,_defineToolbars_: function () {
		...
		this._tlbitms_.add("tlbMEditList___TITLE_",  {xtype:"tbtext", text:"ReportServer"} );
