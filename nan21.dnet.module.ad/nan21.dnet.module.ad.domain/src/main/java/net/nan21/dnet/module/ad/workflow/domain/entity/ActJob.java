...
@NamedQueries({
        ...
        @NamedQuery(name = "ActJob.findByIds", query = "SELECT e FROM ActJob e WHERE e.id in :pIds", hints = @QueryHint(name = QueryHints.BIND_PARAMETERS, value = HintValues.TRUE)) })
@ReadOnly
