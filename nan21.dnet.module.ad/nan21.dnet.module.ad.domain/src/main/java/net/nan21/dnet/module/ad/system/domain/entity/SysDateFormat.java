...
/** SysDateFormat. */
@Entity
@Table(name = SysDateFormat.TABLE_NAME, uniqueConstraints = { @UniqueConstraint(name = "AD_SYSDATEFORMAT_UK1", columnNames = {
        "CLIENTID", "NAME" }) })
@Customizer(DomainEntityEventAdapter.class)
@NamedQueries({
        @NamedQuery(name = "SysDateFormat.findById", query = "SELECT e FROM SysDateFormat e WHERE e.id = :pId", hints = @QueryHint(name = QueryHints.BIND_PARAMETERS, value = HintValues.TRUE)),
        @NamedQuery(name = "SysDateFormat.findByIds", query = "SELECT e FROM SysDateFormat e WHERE e.id in :pIds", hints = @QueryHint(name = QueryHints.BIND_PARAMETERS, value = HintValues.TRUE)),
        @NamedQuery(name = "SysDateFormat.findByName", query = "SELECT e FROM SysDateFormat e WHERE e.clientId = :pClientId and  e.name = :pName ", hints = @QueryHint(name = QueryHints.BIND_PARAMETERS, value = HintValues.TRUE)) })
public class SysDateFormat implements Serializable, IModelWithId,
        IModelWithClientId {

    public static final String TABLE_NAME = "AD_SYSDATEFORMAT";
    public static final String SEQUENCE_NAME = "AD_SYSDATEFORMAT_SEQ";
    ...
    public void aboutToUpdate(DescriptorEvent event) {
        ...
        SysDateFormat e = (SysDateFormat) event.getSource();
