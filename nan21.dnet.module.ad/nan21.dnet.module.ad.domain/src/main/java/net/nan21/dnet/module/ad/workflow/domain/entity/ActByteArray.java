...
@NamedQueries({
        ...
        @NamedQuery(name = "ActByteArray.findByIds", query = "SELECT e FROM ActByteArray e WHERE e.id in :pIds", hints = @QueryHint(name = QueryHints.BIND_PARAMETERS, value = HintValues.TRUE)) })
@ReadOnly
