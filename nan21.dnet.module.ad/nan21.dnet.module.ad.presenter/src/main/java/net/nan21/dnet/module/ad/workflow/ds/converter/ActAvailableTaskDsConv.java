...
public class ActAvailableTaskDsConv extends
        AbstractDsConverter<ActAvailableTaskDs, ActTask> implements
        IDsConverter<ActAvailableTaskDs, ActTask> {

    protected void modelToEntityAttributes(ActAvailableTaskDs ds, ActTask e)
            throws Exception {
    ...
    protected void modelToEntityReferences(ActAvailableTaskDs ds, ActTask e)
            throws Exception {
    }

    @Override
    public void entityToModel(ActTask e, ActAvailableTaskDs ds)
            throws Exception {
        ds.setId(e.getId());
