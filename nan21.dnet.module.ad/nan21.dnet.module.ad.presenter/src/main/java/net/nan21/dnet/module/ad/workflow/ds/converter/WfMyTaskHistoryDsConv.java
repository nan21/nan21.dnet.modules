...
import net.nan21.dnet.module.ad.workflow.ds.model.WfMyTaskHistoryDs;
import net.nan21.dnet.module.ad.workflow.domain.entity.WfTaskInstance;

public class WfMyTaskHistoryDsConv extends
        AbstractDsConverter<WfMyTaskHistoryDs, WfTaskInstance> implements
        IDsConverter<WfMyTaskHistoryDs, WfTaskInstance> {

    protected void modelToEntityAttributes(WfMyTaskHistoryDs ds,
    ...
    protected void modelToEntityReferences(WfMyTaskHistoryDs ds,
            WfTaskInstance e) throws Exception {
    }

    @Override
    public void entityToModel(WfTaskInstance e, WfMyTaskHistoryDs ds)
            throws Exception {
        ds.setId(e.getId());
