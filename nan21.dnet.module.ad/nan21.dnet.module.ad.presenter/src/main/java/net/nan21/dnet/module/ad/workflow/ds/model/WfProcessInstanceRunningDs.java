...
@Ds(entity = WfProcessInstance.class, jpqlWhere = " e.endTime is null ", sort = { @SortField(field = WfProcessInstanceRunningDs.fSTARTTIME, desc = true) })
public class WfProcessInstanceRunningDs extends
    ...
    public WfProcessInstanceRunningDs() {
        super();
    }

    public WfProcessInstanceRunningDs(WfProcessInstance e) {
        super(e);
    }
