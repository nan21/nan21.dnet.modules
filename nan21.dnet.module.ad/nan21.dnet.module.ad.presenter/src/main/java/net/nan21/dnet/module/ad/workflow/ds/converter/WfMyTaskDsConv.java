...
public class WfMyTaskDsConv extends
        AbstractDsConverter<WfMyTaskDs, WfTaskInstance> implements
        IDsConverter<WfMyTaskDs, WfTaskInstance> {

    protected void modelToEntityAttributes(WfMyTaskDs ds, WfTaskInstance e)
            throws Exception {
    ...
    protected void modelToEntityReferences(WfMyTaskDs ds, WfTaskInstance e)
            throws Exception {
    }

    @Override
    public void entityToModel(WfTaskInstance e, WfMyTaskDs ds) throws Exception {
        ds.setId(e.getId());
