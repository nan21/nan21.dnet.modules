...
Ext.define("net.nan21.dnet.module.pj.md.dc.Issue$List", {
	...
	,_defineColumns_: function () {	
		...
		.addTextColumn({ name:"uuid", dataIndex:"uuid", hidden:true,width:100 })   	
...
Ext.define("net.nan21.dnet.module.pj.md.dc.Issue$Edit", {
	...
	_defineElements_: function () {	
		...
		.addLov({ name:"reportedVersion", xtype:"net.nan21.dnet.module.pj.md.lovs.ProjectVersionsReleased", dataIndex:"reportedVersion",anchor:"-20" ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "reportedVersionId"} ]  })
		.addLov({ name:"targetVersion", xtype:"net.nan21.dnet.module.pj.md.lovs.ProjectVersionsPlanned", dataIndex:"targetVersion",anchor:"-20" ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "targetVersionId"} ]  })
		.addLov({ name:"fixedInVersion", xtype:"net.nan21.dnet.module.pj.md.lovs.ProjectVersions", dataIndex:"fixedInVersion",anchor:"-20" ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "fixedInVersionId"} ]  })
		//containers
