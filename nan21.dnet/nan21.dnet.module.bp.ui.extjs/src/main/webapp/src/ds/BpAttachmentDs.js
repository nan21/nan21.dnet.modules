...
Ext.define("net.nan21.dnet.module.bp.md.ds.model.BpAttachmentDs" ,{
...
Ext.define("net.nan21.dnet.module.bp.md.ds.model.BpAttachmentDsFilter" ,{
	extend: 'Ext.data.Model',
	fields: [ 
		{name:"id", type:"int", useNull:true},
		{name:"uuid", type:"string"},
...
Ext.define("net.nan21.dnet.module.bp.md.ds.param.BpAttachmentDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
	]
}); 
