...
@Ds(entity = SalesOrderAttachment.class)
public class SalesOrderAttachmentDs extends
        AbstractDsModel<SalesOrderAttachment> implements IModelWithId,
        IModelWithClientId {
    ...
    public SalesOrderAttachmentDs() {
        super();
    }

    public SalesOrderAttachmentDs(SalesOrderAttachment e) {
        super(e);
    }
