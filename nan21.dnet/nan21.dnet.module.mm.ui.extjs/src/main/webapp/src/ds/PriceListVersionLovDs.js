...
Ext.define("net.nan21.dnet.module.mm.price.ds.model.PriceListVersionLovDs" ,{
...
Ext.define("net.nan21.dnet.module.mm.price.ds.model.PriceListVersionLovDsFilter" ,{
	extend: 'Ext.data.Model',
	fields: [ 
		{name:"id", type:"int", useNull:true},
		{name:"name", type:"string"},
...
Ext.define("net.nan21.dnet.module.mm.price.ds.param.PriceListVersionLovDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
	]
}); 
