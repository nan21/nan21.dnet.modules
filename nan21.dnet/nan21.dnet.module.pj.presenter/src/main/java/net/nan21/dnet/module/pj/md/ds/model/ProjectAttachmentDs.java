...
@Ds(entity = ProjectAttachment.class)
public class ProjectAttachmentDs extends AbstractDsModel<ProjectAttachment>
    ...
    public ProjectAttachmentDs() {
        super();
    }

    public ProjectAttachmentDs(ProjectAttachment e) {
        super(e);
    }
