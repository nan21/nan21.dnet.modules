...
/** JobType. */
@Entity
@Table(name = "HR_JOB_TYPE", uniqueConstraints = { @UniqueConstraint(name = "UK_NAME", columnNames = {
        "CLIENTID", "NAME" }) })
@Customizer(DomainEntityEventAdapter.class)
@NamedQueries({
        @NamedQuery(name = "JobType.findById", query = "SELECT e FROM JobType e WHERE e.id = :pId", hints = @QueryHint(name = QueryHints.BIND_PARAMETERS, value = HintValues.TRUE)),
