...
Ext.define("net.nan21.dnet.module.hr.payroll.ds.model.ElementInputDs" ,{
...
Ext.define("net.nan21.dnet.module.hr.payroll.ds.model.ElementInputDsFilter" ,{
	extend: 'Ext.data.Model',
	fields: [ 
		{name:"id", type:"int", useNull:true},
		{name:"uuid", type:"string"},
...
Ext.define("net.nan21.dnet.module.hr.payroll.ds.param.ElementInputDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
	]
}); 
