...
net.nan21.dnet.module.hr.job.frame.WorkRequirementType_UI = Ext.extend( dnet.base.AbstractUi, {  
	...
	,_defineDcs_: function () {	
		var  m = new net.nan21.dnet.module.hr.job.dc.WorkRequirementType({multiEdit:true});	 	
	...
	,_defineElements_: function () {
		this._elems_.add("mFilter", { xtype:"net.nan21.dnet.module.hr.job.dc.WorkRequirementType$Filter", id:Ext.id(), _controller_:this._dcs_.get("m") ,listeners:{ activate:{scope:this,fn:function(){this.doLayout(false,true);} } } });	
		this._elems_.add("mEditList", { xtype:"net.nan21.dnet.module.hr.job.dc.WorkRequirementType$EditList", frame:true, id:Ext.id(), _controller_:this._dcs_.get("m") ,listeners:{ activate:{scope:this,fn:function(){this.doLayout(false,true);} } } });	
	...
	,_defineToolbars_: function () {
		...
		this._tlbitms_.add("tlb___TITLE_",  {xtype:"tbtext", text:"WorkRequirementType"} );
