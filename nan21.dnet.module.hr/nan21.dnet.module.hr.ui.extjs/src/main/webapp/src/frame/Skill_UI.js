...
Ext.define("net.nan21.dnet.module.hr.skill.frame.Skill_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("m",{ name:"mFilter", xtype:"net.nan21.dnet.module.hr.skill.dc.Skill$Filter",height:80})	 
		.addDcEditGridView("m",{ name:"mEditList", xtype:"net.nan21.dnet.module.hr.skill.dc.Skill$EditList", frame:true})	 
...
;	 	
	...
	,_defineToolbars_: function() {
		this._getBuilder_()
			.beginToolbar("tlb", {dc:"m"}).addQuery().addSave().addNew().addCopy().addDeleteSelected().addCancel().addReports().addSeparator().addSeparator().addTitle({"text":"Skills"}).end(); 	
	}
