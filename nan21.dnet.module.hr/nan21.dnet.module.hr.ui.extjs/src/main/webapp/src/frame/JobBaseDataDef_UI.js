...
net.nan21.dnet.module.hr.job.frame.JobBaseDataDef_UI = Ext.extend( dnet.base.AbstractUi, {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("jobType",{ name:"jobTypeFilter", xtype:"net.nan21.dnet.module.hr.job.dc.JobType$Filter",height:35})	 
		.addDcView("jobType",{ name:"jobTypeEditList", xtype:"net.nan21.dnet.module.hr.job.dc.JobType$EditList", frame:true})	 
		.addDcFilterFormView("wrType",{ name:"wrTypeFilter", xtype:"net.nan21.dnet.module.hr.job.dc.WorkRequirementType$Filter",height:35})	 
		.addDcView("wrType",{ name:"wrTypeEditList", xtype:"net.nan21.dnet.module.hr.job.dc.WorkRequirementType$EditList", frame:true})	 
		.addDcFilterFormView("wr",{ name:"wrFilter", xtype:"net.nan21.dnet.module.hr.job.dc.WorkRequirement$Filter",height:35})	 
		.addDcView("wr",{ name:"wrEditList", xtype:"net.nan21.dnet.module.hr.job.dc.WorkRequirement$EditList", frame:true})	 
		.addPanel({name: "main",layout:"card", activeItem:0})  	 
		.addPanel({name: "canvasJobType", layout:"border", defaults:{split:true},title:"Job types",header:false})  	 
		.addPanel({name: "canvasWrType", layout:"border", defaults:{split:true},title:"Work requirement types",header:false})  	 
		.addPanel({name: "canvasWr", layout:"border", defaults:{split:true},title:"Work requirement",header:false})  	 
...
Ext.reg("net.nan21.dnet.module.hr.job.frame.JobBaseDataDef_UI", net.nan21.dnet.module.hr.job.frame.JobBaseDataDef_UI);   
