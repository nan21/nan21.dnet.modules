...
Ext.define("net.nan21.dnet.module.hr.payroll.frame.ElementInputs_UI", {  
	extend: "dnet.core.ui.AbstractUi",
	alias:"widget.net.nan21.dnet.module.hr.payroll.frame.ElementInputs_UI",
	
	 _name_ : "net.nan21.dnet.module.hr.payroll.frame.ElementInputs_UI"
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("input",{ name:"inputFilter", xtype:"net.nan21.dnet.module.hr.payroll.dc.ElementInput$Filter",height:120})	 
		.addDcEditGridView("input",{ name:"inputList", xtype:"net.nan21.dnet.module.hr.payroll.dc.ElementInput$EditList", frame:true})	 
