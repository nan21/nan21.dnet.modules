...
Ext.define("net.nan21.dnet.module.hr.time.frame.AbsenceBaseData_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("abscateg",{ name:"abscategFilter", xtype:"net.nan21.dnet.module.hr.time.dc.AbsenceCategory$Filter",height:40})	 
		.addDcView("abscateg",{ name:"abscategEditList", xtype:"net.nan21.dnet.module.hr.time.dc.AbsenceCategory$EditList", frame:true})	 
		.addDcFilterFormView("abstype",{ name:"abstypeFilter", xtype:"net.nan21.dnet.module.hr.time.dc.AbsenceType$Filter",height:40})	 
		.addDcView("abstype",{ name:"abstypeEditList", xtype:"net.nan21.dnet.module.hr.time.dc.AbsenceType$EditList", frame:true})	 
		.addDcFilterFormView("absreason",{ name:"absreasonFilter", xtype:"net.nan21.dnet.module.hr.time.dc.AbsenceReason$Filter",height:40})	 
		...
		.addPanel({name: "canvasType", layout:"border", defaults:{split:true},title:"Absence types",preventHeader:true})  	 
		.addPanel({name: "canvasReason", layout:"border", defaults:{split:true},title:"Absence reasons",preventHeader:true})  	 
