...
Ext.define("net.nan21.dnet.module.hr.employee.frame.Employee_UI", {  
	...
	,_defineDcs_: function() {	
		...
		.linkDc("asgn", "emp",{fields:[ {childField:"employeeId", parentField:"id"} ]} )
	...
	,_defineElements_: function() {							
		...
		.addDcFilterFormView("emp",{ name:"empFilter", xtype:"net.nan21.dnet.module.hr.employee.dc.Employee$Filter",height:140})	 
		.addDcGridView("emp",{ name:"empList", xtype:"net.nan21.dnet.module.hr.employee.dc.Employee$List"})	 
		.addDcFormView("emp",{ name:"empEditMain", xtype:"net.nan21.dnet.module.hr.employee.dc.Employee$EditMain",height:140})	 
		.addDcFormView("emp",{ name:"empEditOther", xtype:"net.nan21.dnet.module.hr.employee.dc.Employee$EditOther",title:"Details"})	 
		.addDcGridView("asgn",{ name:"asgnList", xtype:"net.nan21.dnet.module.hr.employee.dc.EmployeeAssignment$CtxList"})	 
		...
		.addPanel({name: "asgnPanel",layout:"card", activeItem:0,title:"Assignments"})  	 
...
;	 	
	...
	,_defineToolbars_: function() {
		this._getBuilder_()
			...
			.beginToolbar("tlbAsgnList", {dc:"asgn"}).addQuery().addEdit({inContainer:"asgnPanel",showView:"asgnEditWrapper"}).addNew().addCopy().addDeleteSelected().addSeparator().addAutoLoad().addReports().addSeparator().addSeparator().addTitle({"text":"Assignments"}).end()
			.beginToolbar("tlbAsgnEdit", {dc:"asgn"}).addBack({inContainer:"asgnPanel",showView:"asgnList"}).addSave().addNew().addCopy().addCancel().addPrevRec().addNextRec().addSeparator().addAutoLoad().addReports().addSeparator().addSeparator().addTitle({"text":"Assignment"}).end(); 	
	}
