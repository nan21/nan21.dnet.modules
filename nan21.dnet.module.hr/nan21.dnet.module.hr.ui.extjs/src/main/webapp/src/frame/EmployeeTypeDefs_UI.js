...
Ext.define("net.nan21.dnet.module.hr.employee.frame.EmployeeTypeDefs_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("educType",{ name:"educTypeFilter", xtype:"net.nan21.dnet.module.hr.employee.dc.EducationType$Filter",height:80})	 
		.addDcEditGridView("educType",{ name:"educTypeEditList", xtype:"net.nan21.dnet.module.hr.employee.dc.EducationType$EditList", frame:true})	 
		.addDcFilterFormView("contactRel",{ name:"contactRelFilter", xtype:"net.nan21.dnet.module.hr.employee.dc.EmployeeContactRelationship$Filter",height:80})	 
		.addDcEditGridView("contactRel",{ name:"contactRelEditList", xtype:"net.nan21.dnet.module.hr.employee.dc.EmployeeContactRelationship$EditList", frame:true})	 
		.addDcFilterFormView("licType",{ name:"licTypeFilter", xtype:"net.nan21.dnet.module.hr.employee.dc.LicenseType$Filter",height:80})	 
		.addDcEditGridView("licType",{ name:"licTypeEditList", xtype:"net.nan21.dnet.module.hr.employee.dc.LicenseType$EditList", frame:true})	 
		.addDcFilterFormView("asgnType",{ name:"asgnTypeFilter", xtype:"net.nan21.dnet.module.hr.employee.dc.EmploymentType$Filter",height:80})	 
		.addDcEditGridView("asgnType",{ name:"asgnTypeEditList", xtype:"net.nan21.dnet.module.hr.employee.dc.EmploymentType$EditList", frame:true})	 
