...
Ext.define("net.nan21.dnet.module.hr.payroll.frame.PayrollElementFormulas_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("formula",{ name:"formulaFilter", xtype:"net.nan21.dnet.module.bd.elem.dc.ElementFormula$Filter",height:120})	 
		.addDcEditGridView("formula",{ name:"formulaList", xtype:"net.nan21.dnet.module.bd.elem.dc.ElementFormula$EditList", frame:true})	 
		.addDcFormView("formula",{ name:"formulaEdit", xtype:"net.nan21.dnet.module.bd.elem.dc.ElementFormula$EditExpression",width:350})	 
