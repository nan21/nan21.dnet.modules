...
net.nan21.dnet.module.hr.employee.dc.LicenseType = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"LicenseType" 		 
			,ds: new net.nan21.dnet.module.hr.employee.ds.LicenseTypeDs()			  
		});
	 	net.nan21.dnet.module.hr.employee.dc.LicenseType.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.hr.employee.dc'); 
net.nan21.dnet.module.hr.employee.dc.LicenseType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.hr.employee.dc.LicenseType$Filter", net.nan21.dnet.module.hr.employee.dc.LicenseType$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.hr.employee.dc');	 	 
net.nan21.dnet.module.hr.employee.dc.LicenseType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
...
Ext.reg("net.nan21.dnet.module.hr.employee.dc.LicenseType$EditList", net.nan21.dnet.module.hr.employee.dc.LicenseType$EditList ); 
