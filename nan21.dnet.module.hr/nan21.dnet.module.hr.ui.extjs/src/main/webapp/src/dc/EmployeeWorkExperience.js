...
net.nan21.dnet.module.hr.employee.dc.EmployeeWorkExperience = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"EmployeeWorkExperience" 		 
			,ds: new net.nan21.dnet.module.hr.employee.ds.EmployeeWorkExperienceDs()			  
		});
	 	net.nan21.dnet.module.hr.employee.dc.EmployeeWorkExperience.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.hr.employee.dc');	 	 
net.nan21.dnet.module.hr.employee.dc.EmployeeWorkExperience$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
...
Ext.reg("net.nan21.dnet.module.hr.employee.dc.EmployeeWorkExperience$EditList", net.nan21.dnet.module.hr.employee.dc.EmployeeWorkExperience$EditList ); 
