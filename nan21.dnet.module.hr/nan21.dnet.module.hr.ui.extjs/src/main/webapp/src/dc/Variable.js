...
net.nan21.dnet.module.hr.payroll.dc.Variable$CtxEditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	...
	,_defineColumns_: function () {		
		this._columns_.add("elementId", { xtype:"numbercolumn", dataIndex:"elementId", sortable:true, hidden:true, align:"right",format:"0",width:70,editable:false ,editor:{xtype:"numberfield", selectOnFocus:true ,decimalPrecision:2 } });
		...
		this._columns_.add("crossReferenceId", { xtype:"numbercolumn", dataIndex:"crossReferenceId", sortable:true, hidden:true, align:"right",format:"0",width:70,editable:false ,editor:{xtype:"numberfield", selectOnFocus:true ,decimalPrecision:2 } });
		this._columns_.add("crossReference", { xtype:"gridcolumn", dataIndex:"crossReference", sortable:true, hidden:false,width:200,editor:{xtype:"net.nan21.dnet.module.hr.payroll.lovs.Elements" , selectOnFocus:true,maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "crossReferenceId"} ]} });
