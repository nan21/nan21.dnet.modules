...
net.nan21.dnet.module.hr.job.dc.WorkRequirementType = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"WorkRequirementType" 		 
			,ds: new net.nan21.dnet.module.hr.job.ds.WorkRequirementTypeDs()			  
		});
	 	net.nan21.dnet.module.hr.job.dc.WorkRequirementType.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.hr.job.dc'); 
net.nan21.dnet.module.hr.job.dc.WorkRequirementType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.hr.job.dc.WorkRequirementType$Filter", net.nan21.dnet.module.hr.job.dc.WorkRequirementType$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.hr.job.dc');	 	 
net.nan21.dnet.module.hr.job.dc.WorkRequirementType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
...
Ext.reg("net.nan21.dnet.module.hr.job.dc.WorkRequirementType$EditList", net.nan21.dnet.module.hr.job.dc.WorkRequirementType$EditList ); 
