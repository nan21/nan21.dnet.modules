...
net.nan21.dnet.module.hr.skill.dc.SkillType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
	...
	_defineElements_: function () {	
		...
		this._elems_.add("category", { name:"category", xtype:"net.nan21.dnet.module.hr.skill.lovs.SkillCategories", dataIndex:"category", id:Ext.id(),anchor:"-20",maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "categoryId"} ]  });
...
net.nan21.dnet.module.hr.skill.dc.SkillType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	...
	,_defineColumns_: function () {		
		...
		this._columns_.add("category", { xtype:"gridcolumn", dataIndex:"category", sortable:true, hidden:false,width:120,editor:{xtype:"net.nan21.dnet.module.hr.skill.lovs.SkillCategories" , selectOnFocus:true,maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "categoryId"} ]} });
