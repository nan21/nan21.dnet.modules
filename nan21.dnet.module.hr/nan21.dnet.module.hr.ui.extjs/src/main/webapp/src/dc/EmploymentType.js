...
net.nan21.dnet.module.hr.employee.dc.EmploymentType = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"EmploymentType" 		 
			,ds: new net.nan21.dnet.module.hr.employee.ds.EmploymentTypeDs()			  
		});
	 	net.nan21.dnet.module.hr.employee.dc.EmploymentType.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.hr.employee.dc'); 
net.nan21.dnet.module.hr.employee.dc.EmploymentType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.hr.employee.dc.EmploymentType$Filter", net.nan21.dnet.module.hr.employee.dc.EmploymentType$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.hr.employee.dc');	 	 
net.nan21.dnet.module.hr.employee.dc.EmploymentType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.hr.employee.dc.EmploymentType$EditList", net.nan21.dnet.module.hr.employee.dc.EmploymentType$EditList ); 
