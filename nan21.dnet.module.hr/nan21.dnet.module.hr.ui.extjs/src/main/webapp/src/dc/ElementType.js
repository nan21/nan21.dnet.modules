...
net.nan21.dnet.module.hr.payroll.dc.ElementType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
	...
	_defineElements_: function () {	
		...
		.addLov({ name:"category", xtype:"net.nan21.dnet.module.hr.payroll.lovs.ElementCategories", dataIndex:"category",anchor:"-20",maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "categoryId"} ]  })
		//containers
...
net.nan21.dnet.module.hr.payroll.dc.ElementType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	...
	,_defineColumns_: function () {
		...
		.addLov({name:"category", xtype:"gridcolumn", dataIndex:"category",width:120,editor:{xtype:"net.nan21.dnet.module.hr.payroll.lovs.ElementCategories" , selectOnFocus:true,maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "categoryId"} ]} })
