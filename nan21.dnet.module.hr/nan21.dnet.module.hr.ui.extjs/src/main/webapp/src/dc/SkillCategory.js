...
net.nan21.dnet.module.hr.skill.dc.SkillCategory = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"SkillCategory" 		 
			,ds: new net.nan21.dnet.module.hr.skill.ds.SkillCategoryDs()			  
		});
	 	net.nan21.dnet.module.hr.skill.dc.SkillCategory.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.hr.skill.dc'); 
net.nan21.dnet.module.hr.skill.dc.SkillCategory$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.hr.skill.dc.SkillCategory$Filter", net.nan21.dnet.module.hr.skill.dc.SkillCategory$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.hr.skill.dc');	 	 
net.nan21.dnet.module.hr.skill.dc.SkillCategory$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
...
Ext.reg("net.nan21.dnet.module.hr.skill.dc.SkillCategory$EditList", net.nan21.dnet.module.hr.skill.dc.SkillCategory$EditList ); 
