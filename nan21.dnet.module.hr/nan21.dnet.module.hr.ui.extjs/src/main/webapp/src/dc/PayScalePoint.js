...
net.nan21.dnet.module.hr.grade.dc.PayScalePoint$CtxEditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	...
	,_defineColumns_: function () {		
		this._columns_.add("payScaleId", { xtype:"numbercolumn", dataIndex:"payScaleId", sortable:true, hidden:true, align:"right",format:"0",width:70,editable:false ,editor:{xtype:"numberfield", selectOnFocus:true ,decimalPrecision:2 } });
