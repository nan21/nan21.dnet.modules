...
net.nan21.dnet.module.hr.job.dc.JobType = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"JobType" 		 
			,ds: new net.nan21.dnet.module.hr.job.ds.JobTypeDs()			  
		});
	 	net.nan21.dnet.module.hr.job.dc.JobType.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.hr.job.dc'); 
net.nan21.dnet.module.hr.job.dc.JobType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.hr.job.dc.JobType$Filter", net.nan21.dnet.module.hr.job.dc.JobType$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.hr.job.dc');	 	 
net.nan21.dnet.module.hr.job.dc.JobType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
...
Ext.reg("net.nan21.dnet.module.hr.job.dc.JobType$EditList", net.nan21.dnet.module.hr.job.dc.JobType$EditList ); 
