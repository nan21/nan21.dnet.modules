...
net.nan21.dnet.module.hr.time.dc.AbsenceCategory = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"AbsenceCategory" 		 
			,ds: new net.nan21.dnet.module.hr.time.ds.AbsenceCategoryDs()			  
		});
	 	net.nan21.dnet.module.hr.time.dc.AbsenceCategory.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.hr.time.dc'); 
net.nan21.dnet.module.hr.time.dc.AbsenceCategory$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.hr.time.dc.AbsenceCategory$Filter", net.nan21.dnet.module.hr.time.dc.AbsenceCategory$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.hr.time.dc');	 	 
net.nan21.dnet.module.hr.time.dc.AbsenceCategory$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.hr.time.dc.AbsenceCategory$EditList", net.nan21.dnet.module.hr.time.dc.AbsenceCategory$EditList ); 
