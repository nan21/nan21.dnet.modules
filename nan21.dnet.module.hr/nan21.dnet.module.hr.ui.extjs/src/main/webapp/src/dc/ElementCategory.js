...
net.nan21.dnet.module.hr.payroll.dc.ElementCategory = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"ElementCategory" 		 
			,ds: new net.nan21.dnet.module.hr.payroll.ds.ElementCategoryDs()			  
		});
	 	net.nan21.dnet.module.hr.payroll.dc.ElementCategory.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.hr.payroll.dc'); 
net.nan21.dnet.module.hr.payroll.dc.ElementCategory$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.hr.payroll.dc.ElementCategory$Filter", net.nan21.dnet.module.hr.payroll.dc.ElementCategory$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.hr.payroll.dc');	 	 
net.nan21.dnet.module.hr.payroll.dc.ElementCategory$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.hr.payroll.dc.ElementCategory$EditList", net.nan21.dnet.module.hr.payroll.dc.ElementCategory$EditList ); 
