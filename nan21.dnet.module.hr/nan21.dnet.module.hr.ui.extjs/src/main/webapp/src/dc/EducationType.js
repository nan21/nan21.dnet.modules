...
net.nan21.dnet.module.hr.employee.dc.EducationType = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"EducationType" 		 
			,ds: new net.nan21.dnet.module.hr.employee.ds.EducationTypeDs()			  
		});
	 	net.nan21.dnet.module.hr.employee.dc.EducationType.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.hr.employee.dc'); 
net.nan21.dnet.module.hr.employee.dc.EducationType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.hr.employee.dc.EducationType$Filter", net.nan21.dnet.module.hr.employee.dc.EducationType$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.hr.employee.dc');	 	 
net.nan21.dnet.module.hr.employee.dc.EducationType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
...
Ext.reg("net.nan21.dnet.module.hr.employee.dc.EducationType$EditList", net.nan21.dnet.module.hr.employee.dc.EducationType$EditList ); 
