...
net.nan21.dnet.module.hr.job.dc.WorkRequirement = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"WorkRequirement" 		 
			,ds: new net.nan21.dnet.module.hr.job.ds.WorkRequirementDs()			  
		});
	 	net.nan21.dnet.module.hr.job.dc.WorkRequirement.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.hr.job.dc'); 
net.nan21.dnet.module.hr.job.dc.WorkRequirement$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
	...
	_defineElements_: function () {	
		...
		this._elems_.add("type", { name:"type", xtype:"net.nan21.dnet.module.hr.job.lovs.WorkRequirementTypes", dataIndex:"type", id:Ext.id(),anchor:"-20",maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "typeId"} ]  });
		//containers
...
Ext.ns('net.nan21.dnet.module.hr.job.dc');	 	 
net.nan21.dnet.module.hr.job.dc.WorkRequirement$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	...
	,_defineColumns_: function () {		
		...
		this._columns_.add("type", { xtype:"gridcolumn", dataIndex:"type", sortable:true, hidden:false,width:120,editor:{xtype:"net.nan21.dnet.module.hr.job.lovs.WorkRequirementTypes" , selectOnFocus:true,maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "typeId"} ]} });
...
Ext.reg("net.nan21.dnet.module.hr.job.dc.WorkRequirement$EditList", net.nan21.dnet.module.hr.job.dc.WorkRequirement$EditList ); 
