...
net.nan21.dnet.module.hr.skill.dc.Skill$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
	...
	_defineElements_: function () {	
		...
		this._elems_.add("type", { name:"type", xtype:"net.nan21.dnet.module.hr.skill.lovs.SkillTypes", dataIndex:"type", id:Ext.id(),anchor:"-20",maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "typeId"} ]  });
	...
	,_linkElements_: function () {
		...
		this._elems_.get("col2")["items"] = [this._elems_.get("type") ,this._elems_.get("ratingScale") ];
	}
}); 
...
net.nan21.dnet.module.hr.skill.dc.Skill$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	...
	,_defineColumns_: function () {		
		...
		this._columns_.add("type", { xtype:"gridcolumn", dataIndex:"type", sortable:true, hidden:false,width:120,editor:{xtype:"net.nan21.dnet.module.hr.skill.lovs.SkillTypes" , selectOnFocus:true,maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "typeId"} ]} });
