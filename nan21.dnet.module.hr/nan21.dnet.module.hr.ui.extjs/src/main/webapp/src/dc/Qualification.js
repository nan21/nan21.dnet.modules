...
net.nan21.dnet.module.hr.skill.dc.Qualification = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"Qualification" 		 
			,ds: new net.nan21.dnet.module.hr.skill.ds.QualificationDs()			  
		});
	 	net.nan21.dnet.module.hr.skill.dc.Qualification.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.hr.skill.dc'); 
net.nan21.dnet.module.hr.skill.dc.Qualification$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.hr.skill.dc.Qualification$Filter", net.nan21.dnet.module.hr.skill.dc.Qualification$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.hr.skill.dc');	 	 
net.nan21.dnet.module.hr.skill.dc.Qualification$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
...
Ext.reg("net.nan21.dnet.module.hr.skill.dc.Qualification$EditList", net.nan21.dnet.module.hr.skill.dc.Qualification$EditList ); 
