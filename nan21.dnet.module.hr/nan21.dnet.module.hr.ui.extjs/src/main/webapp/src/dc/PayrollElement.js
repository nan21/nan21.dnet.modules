...
Ext.define("net.nan21.dnet.module.hr.payroll.dc.PayrollElement$Edit", {
	...
	_defineElements_: function () {	
		...
		.addNumberField({ name:"sequenceNo", dataIndex:"sequenceNo"  , style: "text-align:right;" })
		.addCombo({ name:"calculation", xtype:"localcombo", dataIndex:"calculation" ,store:[ "manual", "formula"]  })
		.addCombo({ name:"balanceFunction", xtype:"localcombo", dataIndex:"balanceFunction" ,store:[ "sum", "count", "avg"]  })
		...
		.addCombo({ name:"dataType", xtype:"localcombo", dataIndex:"dataType" ,allowBlank:false,store:[ "string", "number", "boolean", "date"]  })
		...
		.addLov({ name:"type", xtype:"net.nan21.dnet.module.bd.elem.lovs.ElementTypes", dataIndex:"type" ,allowBlank:false, labelSeparator:"*",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "typeId"} ],filterFieldMapping: [{lovField:"engineId", dsField: "engineId"} ]  })
		.addLov({ name:"accItem", xtype:"net.nan21.dnet.module.md.acc.lovs.AccItems", dataIndex:"accItem" ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "accItemId"} ]  })
		.addLov({ name:"sourceElement", xtype:"net.nan21.dnet.module.hr.payroll.lovs.PayrollElementsSource", dataIndex:"sourceElement" ,maxLength:32,retFieldMapping: [{lovField:"id", dsField: "sourceElementId"} ],filterFieldMapping: [{lovField:"engineId", dsField: "engineId"} ]  })
		//containers
