...
net.nan21.dnet.module.hr.employee.dc.EmployeeContactRelationship = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"EmployeeContactRelationship" 		 
			,ds: new net.nan21.dnet.module.hr.employee.ds.EmployeeContactRelationshipDs()			  
		});
	 	net.nan21.dnet.module.hr.employee.dc.EmployeeContactRelationship.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.hr.employee.dc'); 
net.nan21.dnet.module.hr.employee.dc.EmployeeContactRelationship$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.hr.employee.dc.EmployeeContactRelationship$Filter", net.nan21.dnet.module.hr.employee.dc.EmployeeContactRelationship$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.hr.employee.dc');	 	 
net.nan21.dnet.module.hr.employee.dc.EmployeeContactRelationship$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.hr.employee.dc.EmployeeContactRelationship$EditList", net.nan21.dnet.module.hr.employee.dc.EmployeeContactRelationship$EditList ); 
