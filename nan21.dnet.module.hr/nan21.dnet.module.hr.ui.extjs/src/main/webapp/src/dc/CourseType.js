...
net.nan21.dnet.module.hr.training.dc.CourseType = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"CourseType" 		 
			,ds: new net.nan21.dnet.module.hr.training.ds.CourseTypeDs()			  
		});
	 	net.nan21.dnet.module.hr.training.dc.CourseType.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.hr.training.dc'); 
net.nan21.dnet.module.hr.training.dc.CourseType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
	...
	_defineElements_: function () {	
		...
		this._elems_.add("category", { name:"category", xtype:"net.nan21.dnet.module.hr.training.lovs.CourseTypes", dataIndex:"category", id:Ext.id(),anchor:"-20",maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "categoryId"} ]  });
		//containers
	...
	,_linkElements_: function () {
		...
		this._elems_.get("col1")["items"] = [this._elems_.get("name") ,this._elems_.get("category") ];
		this._elems_.get("col2")["items"] = [this._elems_.get("active") ];
	}
}); 
Ext.reg("net.nan21.dnet.module.hr.training.dc.CourseType$Filter", net.nan21.dnet.module.hr.training.dc.CourseType$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.hr.training.dc');	 	 
net.nan21.dnet.module.hr.training.dc.CourseType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	...
	,_defineColumns_: function () {		
		...
		this._columns_.add("category", { xtype:"gridcolumn", dataIndex:"category", sortable:true, hidden:false,width:120,editor:{xtype:"net.nan21.dnet.module.hr.training.lovs.CourseTypes" , selectOnFocus:true,maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "categoryId"} ]} });
...
Ext.reg("net.nan21.dnet.module.hr.training.dc.CourseType$EditList", net.nan21.dnet.module.hr.training.dc.CourseType$EditList ); 
