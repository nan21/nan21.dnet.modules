...
net.nan21.dnet.module.hr.training.dc.CourseCategory = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"CourseCategory" 		 
			,ds: new net.nan21.dnet.module.hr.training.ds.CourseCategoryDs()			  
		});
	 	net.nan21.dnet.module.hr.training.dc.CourseCategory.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.hr.training.dc'); 
net.nan21.dnet.module.hr.training.dc.CourseCategory$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.hr.training.dc.CourseCategory$Filter", net.nan21.dnet.module.hr.training.dc.CourseCategory$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.hr.training.dc');	 	 
net.nan21.dnet.module.hr.training.dc.CourseCategory$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.hr.training.dc.CourseCategory$EditList", net.nan21.dnet.module.hr.training.dc.CourseCategory$EditList ); 
