...
net.nan21.dnet.module.hr.job.dc.JobRequirement = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"JobRequirement" 		 
			,ds: new net.nan21.dnet.module.hr.job.ds.JobRequirementDs()			  
		});
	 	net.nan21.dnet.module.hr.job.dc.JobRequirement.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.hr.job.dc');	 	 
net.nan21.dnet.module.hr.job.dc.JobRequirement$CtxEditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	...
	,_defineColumns_: function () {		
		...
		this._columns_.add("requirementId", { xtype:"numbercolumn", dataIndex:"requirementId", sortable:true, hidden:true, align:"right",format:"0",width:70,editable:false ,editor:{xtype:"numberfield", selectOnFocus:true ,decimalPrecision:2 } });
		this._columns_.add("requirement", { xtype:"gridcolumn", dataIndex:"requirement", sortable:true, hidden:false, width:300,editor:{xtype:"net.nan21.dnet.module.hr.job.lovs.WorkRequirements" , selectOnFocus:true,maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "requirementId"} ]} });
...
Ext.reg("net.nan21.dnet.module.hr.job.dc.JobRequirement$CtxEditList", net.nan21.dnet.module.hr.job.dc.JobRequirement$CtxEditList ); 
