...
Ext.define("net.nan21.dnet.module.mm.md.frame.ProductAttributeDefs_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcEditGridView("categ",{ name:"categEditList", xtype:"net.nan21.dnet.module.mm.md.dc.ProductAttributeCategory$EditList", frame:true})	 
		.addDcFilterFormView("type",{ name:"typeFilter", xtype:"net.nan21.dnet.module.mm.md.dc.ProductAttributeType$Filter",height:120})	 
		.addDcEditGridView("type",{ name:"typeEditList", xtype:"net.nan21.dnet.module.mm.md.dc.ProductAttributeType$EditList", frame:true})	 
		.addDcFilterFormView("attr",{ name:"attrFilter", xtype:"net.nan21.dnet.module.mm.md.dc.ProductAttribute$Filter",height:120})	 
		.addDcEditGridView("attr",{ name:"attrEditList", xtype:"net.nan21.dnet.module.mm.md.dc.ProductAttribute$EditList", frame:true})	 
		.addDcFilterFormView("group",{ name:"groupFilter", xtype:"net.nan21.dnet.module.mm.md.dc.ProductAttributeGroup$Filter",height:120})	 
		.addDcEditGridView("group",{ name:"groupEditList", xtype:"net.nan21.dnet.module.mm.md.dc.ProductAttributeGroup$EditList", frame:true})	 
		.addDcEditGridView("grpattrctx",{ name:"grpattrctxEditList", xtype:"net.nan21.dnet.module.mm.md.dc.ProductAttributeGroupAttribute$CtxEditList", frame:true,height:250})	 
		...
		.addDcEditGridView("grpattr",{ name:"grpattrEditList", xtype:"net.nan21.dnet.module.mm.md.dc.ProductAttributeGroupAttribute$EditList", frame:true})	 
