...
Ext.define("net.nan21.dnet.module.mm.md.frame.ProductAttributeDefs_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcFilterFormView("grpattr",{ name:"grpattrFilter", xtype:"net.nan21.dnet.module.mm.md.dc.ProductAttributeGroupAttribute$Filter",height:80})	 
	...
	,_defineToolbars_: function() {
		this._getBuilder_()
			...
			.beginToolbar("tlbGroupAttrctxEditList", {dc:"grpattrctx"}).addQuery().addSave().addNew().addCopy().addDeleteSelected().addCancel().addSeparator().addAutoLoad().end()
