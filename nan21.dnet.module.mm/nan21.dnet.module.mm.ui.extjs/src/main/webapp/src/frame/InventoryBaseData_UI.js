...
Ext.define("net.nan21.dnet.module.mm.inventory.frame.InventoryBaseData_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcEditGridView("txsrctype",{ name:"txsrctypeEditList", xtype:"net.nan21.dnet.module.mm.inventory.dc.InvTransactionSourceType$EditList", frame:true})	 
		...
		.addDcEditGridView("txaction",{ name:"txactionEditList", xtype:"net.nan21.dnet.module.mm.inventory.dc.InvTransactionAction$EditList", frame:true})	 
