...
Ext.define("net.nan21.dnet.module.mm.md.frame.ProductAttributeValue_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcView("attr",{ name:"attrEditList", xtype:"net.nan21.dnet.module.mm.md.dc.ProductAttributeValue$EditList", frame:true})	 
...
;	 	
	...
	,_defineToolbars_: function() {
		this._getBuilder_()
			.beginToolbar("tlbAttrEditList", {dc:"attr"}).addQuery().addSave().addNew().addCopy().addDeleteSelected().addCancel().addSeparator().addSeparator().addTitle({"text":"Product attribute values"}).end(); 	
	}
