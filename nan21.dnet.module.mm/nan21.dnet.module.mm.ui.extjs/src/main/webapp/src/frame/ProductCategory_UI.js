...
net.nan21.dnet.module.mm.md.frame.ProductCategory_UI = Ext.extend( dnet.base.AbstractUi, {  
	...
	,_defineDcs_: function() {	
		this._getBuilder_()
		.addDc("m", new net.nan21.dnet.module.mm.md.dc.ProductCategory({multiEdit:true}))		;		
	}	 

	,_defineElements_: function() {					
		this._getBuilder_()	
		.addDcFilterFormView("m",{ name:"mFilter", xtype:"net.nan21.dnet.module.mm.md.dc.ProductCategory$Filter"})	 
		.addDcView("m",{ name:"mEditList", xtype:"net.nan21.dnet.module.mm.md.dc.ProductCategory$EditList", frame:true})	 
