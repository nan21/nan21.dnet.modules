...
Ext.define("net.nan21.dnet.module.mm.inventory.frame.InvTransfer_UI", {  
	...
	alias:"widget.net.nan21.dnet.module.mm.inventory.frame.InvTransfer_UI",
	
	 _name_ : "net.nan21.dnet.module.mm.inventory.frame.InvTransfer_UI"
	,_defineDcs_: function() {	
		this._getBuilder_()
		.addDc("tx", new net.nan21.dnet.module.mm.inventory.dc.InvTransfer({}))
