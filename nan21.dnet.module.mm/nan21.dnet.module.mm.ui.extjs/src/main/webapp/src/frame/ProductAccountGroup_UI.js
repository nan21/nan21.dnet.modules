...
Ext.define("net.nan21.dnet.module.mm.md.frame.ProductAccountGroup_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcEditGridView("m",{ name:"mEditList", xtype:"net.nan21.dnet.module.mm.md.dc.ProductAccountGroup$EditList", frame:true})	 
...
;	 	
	...
	,_defineToolbars_: function() {
		this._getBuilder_()
			.beginToolbar("tlb", {dc:"m"}).addQuery().addSave().addNew().addCopy().addDeleteSelected().addCancel().addReports().end(); 	
	}
