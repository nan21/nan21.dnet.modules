...
Ext.define("net.nan21.dnet.module.mm.price.frame.PriceList_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcFilterFormView("pricelist",{ name:"pricelistFilter", xtype:"net.nan21.dnet.module.mm.price.dc.PriceList$FilterH",height:120})	 
		.addDcEditGridView("pricelist",{ name:"pricelistEditList", xtype:"net.nan21.dnet.module.mm.price.dc.PriceList$EditList", frame:true})	 
		.addDcEditGridView("version",{ name:"versionEditList", xtype:"net.nan21.dnet.module.mm.price.dc.PriceListVersion$CtxEditList", frame:true,height:250,dockedItems:[{ xtype:"toolbar", ui:"footer", dock: 'bottom', weight:-1, items:[ this._elems_.get("btnShowCanvas2") ]}]})	 
		...
		.addDcFilterFormView("price",{ name:"priceFilter", xtype:"net.nan21.dnet.module.mm.price.dc.ProductPrice$Filter",height:110})	 
