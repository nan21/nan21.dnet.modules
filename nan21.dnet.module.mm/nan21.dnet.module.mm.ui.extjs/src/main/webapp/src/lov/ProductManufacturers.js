...
net.nan21.dnet.module.mm.md.lovs.ProductManufacturers = Ext.extend( dnet.base.AbstractCombo, {	
	 initComponent : function(){
		...
		this._createStore_(); 
        net.nan21.dnet.module.mm.md.lovs.ProductManufacturers.superclass.initComponent.call(this);
	}	 
}); 
Ext.reg("net.nan21.dnet.module.mm.md.lovs.ProductManufacturers", net.nan21.dnet.module.mm.md.lovs.ProductManufacturers);
