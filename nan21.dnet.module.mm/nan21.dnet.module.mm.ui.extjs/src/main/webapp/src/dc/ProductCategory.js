...
net.nan21.dnet.module.mm.md.dc.ProductCategory$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
	...
	_defineElements_: function () {	
		...
		this._elems_.add("parentName", { name:"parentName", xtype:"net.nan21.dnet.module.mm.md.lovs.ProductCategories", dataIndex:"parentName", id:Ext.id(),anchor:"-20",maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "parentId"} ]  });
		//containers
...
net.nan21.dnet.module.mm.md.dc.ProductCategory$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	...
	,_defineColumns_: function () {		
		...
		this._columns_.add("parentName", { xtype:"gridcolumn", dataIndex:"parentName", sortable:true, hidden:false,width:200,editor:{xtype:"net.nan21.dnet.module.mm.md.lovs.ProductCategories" , selectOnFocus:true,maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "parentId"} ]} });
