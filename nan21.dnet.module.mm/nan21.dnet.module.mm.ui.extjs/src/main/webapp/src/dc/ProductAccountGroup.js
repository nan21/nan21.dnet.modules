...
net.nan21.dnet.module.mm.md.dc.ProductAccountGroup = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"ProductAccountGroup" 		 
			,ds: new net.nan21.dnet.module.mm.md.ds.ProductAccountGroupDs()			  
		});
	 	net.nan21.dnet.module.mm.md.dc.ProductAccountGroup.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.mm.md.dc'); 
net.nan21.dnet.module.mm.md.dc.ProductAccountGroup$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.mm.md.dc.ProductAccountGroup$Filter", net.nan21.dnet.module.mm.md.dc.ProductAccountGroup$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.mm.md.dc');	 	 
net.nan21.dnet.module.mm.md.dc.ProductAccountGroup$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.mm.md.dc.ProductAccountGroup$EditList", net.nan21.dnet.module.mm.md.dc.ProductAccountGroup$EditList ); 
