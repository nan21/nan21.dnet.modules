...
net.nan21.dnet.module.mm.inventory.dc.StockLocatorType = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"StockLocatorType" 		 
			,ds: new net.nan21.dnet.module.mm.inventory.ds.StockLocatorTypeDs()			  
		});
	 	net.nan21.dnet.module.mm.inventory.dc.StockLocatorType.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.mm.inventory.dc'); 
net.nan21.dnet.module.mm.inventory.dc.StockLocatorType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.mm.inventory.dc.StockLocatorType$Filter", net.nan21.dnet.module.mm.inventory.dc.StockLocatorType$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.mm.inventory.dc');	 	 
net.nan21.dnet.module.mm.inventory.dc.StockLocatorType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.mm.inventory.dc.StockLocatorType$EditList", net.nan21.dnet.module.mm.inventory.dc.StockLocatorType$EditList ); 
