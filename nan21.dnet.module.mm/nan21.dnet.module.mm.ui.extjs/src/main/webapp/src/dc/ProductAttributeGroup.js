...
net.nan21.dnet.module.mm.md.dc.ProductAttributeGroup = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"ProductAttributeGroup" 		 
			,ds: new net.nan21.dnet.module.mm.md.ds.ProductAttributeGroupDs()			  
		});
	 	net.nan21.dnet.module.mm.md.dc.ProductAttributeGroup.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.mm.md.dc'); 
net.nan21.dnet.module.mm.md.dc.ProductAttributeGroup$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.mm.md.dc.ProductAttributeGroup$Filter", net.nan21.dnet.module.mm.md.dc.ProductAttributeGroup$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.mm.md.dc');	 	 
net.nan21.dnet.module.mm.md.dc.ProductAttributeGroup$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.mm.md.dc.ProductAttributeGroup$EditList", net.nan21.dnet.module.mm.md.dc.ProductAttributeGroup$EditList ); 
