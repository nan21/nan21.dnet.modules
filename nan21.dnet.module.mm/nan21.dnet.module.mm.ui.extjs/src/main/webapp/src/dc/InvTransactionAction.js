...
net.nan21.dnet.module.mm.inventory.dc.InvTransactionAction = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"InvTransactionAction" 		 
			,ds: new net.nan21.dnet.module.mm.inventory.ds.InvTransactionActionDs()			  
		});
	 	net.nan21.dnet.module.mm.inventory.dc.InvTransactionAction.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.mm.inventory.dc'); 
net.nan21.dnet.module.mm.inventory.dc.InvTransactionAction$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.mm.inventory.dc.InvTransactionAction$Filter", net.nan21.dnet.module.mm.inventory.dc.InvTransactionAction$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.mm.inventory.dc');	 	 
net.nan21.dnet.module.mm.inventory.dc.InvTransactionAction$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.mm.inventory.dc.InvTransactionAction$EditList", net.nan21.dnet.module.mm.inventory.dc.InvTransactionAction$EditList ); 
