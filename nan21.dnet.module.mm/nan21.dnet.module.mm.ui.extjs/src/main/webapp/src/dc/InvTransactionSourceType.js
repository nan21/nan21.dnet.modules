...
net.nan21.dnet.module.mm.inventory.dc.InvTransactionSourceType = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"InvTransactionSourceType" 		 
			,ds: new net.nan21.dnet.module.mm.inventory.ds.InvTransactionSourceTypeDs()			  
		});
	 	net.nan21.dnet.module.mm.inventory.dc.InvTransactionSourceType.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.mm.inventory.dc'); 
net.nan21.dnet.module.mm.inventory.dc.InvTransactionSourceType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.mm.inventory.dc.InvTransactionSourceType$Filter", net.nan21.dnet.module.mm.inventory.dc.InvTransactionSourceType$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.mm.inventory.dc');	 	 
net.nan21.dnet.module.mm.inventory.dc.InvTransactionSourceType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.mm.inventory.dc.InvTransactionSourceType$EditList", net.nan21.dnet.module.mm.inventory.dc.InvTransactionSourceType$EditList ); 
