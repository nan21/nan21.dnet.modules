...
net.nan21.dnet.module.mm.md.dc.ProductManufacturer = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"ProductManufacturer" 		 
			,ds: new net.nan21.dnet.module.mm.md.ds.ProductManufacturerDs()			  
		});
	 	net.nan21.dnet.module.mm.md.dc.ProductManufacturer.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.mm.md.dc'); 
net.nan21.dnet.module.mm.md.dc.ProductManufacturer$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.ns('net.nan21.dnet.module.mm.md.dc');	 	 
net.nan21.dnet.module.mm.md.dc.ProductManufacturer$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.mm.md.dc.ProductManufacturer$EditList", net.nan21.dnet.module.mm.md.dc.ProductManufacturer$EditList ); 
