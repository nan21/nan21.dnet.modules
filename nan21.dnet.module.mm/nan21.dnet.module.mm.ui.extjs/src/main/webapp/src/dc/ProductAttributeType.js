...
net.nan21.dnet.module.mm.md.dc.ProductAttributeType = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"ProductAttributeType" 		 
			,ds: new net.nan21.dnet.module.mm.md.ds.ProductAttributeTypeDs()			  
		});
	 	net.nan21.dnet.module.mm.md.dc.ProductAttributeType.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.mm.md.dc'); 
net.nan21.dnet.module.mm.md.dc.ProductAttributeType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
	...
	_defineElements_: function () {	
		...
		.addLov({ name:"category", xtype:"net.nan21.dnet.module.mm.md.lovs.ProductAttributeCategory", dataIndex:"category",anchor:"-20",maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "categoryId"} ]  })
		//containers
...
Ext.reg("net.nan21.dnet.module.mm.md.dc.ProductAttributeType$Filter", net.nan21.dnet.module.mm.md.dc.ProductAttributeType$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.mm.md.dc');	 	 
net.nan21.dnet.module.mm.md.dc.ProductAttributeType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
	,_defineColumns_: function () {
		...
		.addNumberColumn({ name:"categoryId", dataIndex:"categoryId", hidden:true, align:"right",format:"0",width:70,editable:false ,editor:{xtype:"numberfield", selectOnFocus:true ,decimalPrecision:2 } })
	  ;  		   
	}  
});
Ext.reg("net.nan21.dnet.module.mm.md.dc.ProductAttributeType$EditList", net.nan21.dnet.module.mm.md.dc.ProductAttributeType$EditList ); 
