...
Ext.define("net.nan21.dnet.module.mm.inventory.dc.InvTransactionLine$List", {
	extend: "dnet.core.dc.AbstractDcvGrid",
	alias:"widget.net.nan21.dnet.module.mm.inventory.dc.InvTransactionLine$List",
...
Ext.define("net.nan21.dnet.module.mm.inventory.dc.InvTransactionLine$EditList", {
	...
	_defineColumns_: function () {
		this._getBuilder_()
		.addLov({name:"itemCode", xtype:"gridcolumn", dataIndex:"itemCode", width:150,editor:{xtype:"net.nan21.dnet.module.mm.md.lovs.ProductsWithUom" , selectOnFocus:true ,maxLength:32,retFieldMapping: [{lovField:"id", dsField: "itemId"} ,{lovField:"name", dsField: "item"} ,{lovField:"uomId", dsField: "uomId"} ,{lovField:"uom", dsField: "uom"} ]} })
		.addTextColumn({ name:"item", dataIndex:"item", hidden:true,width:200 })
		.addLov({name:"fromSubInventory", xtype:"gridcolumn", dataIndex:"fromSubInventory", width:150,editor:{xtype:"net.nan21.dnet.module.mm.inventory.lovs.SubInventorys" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "fromSubInventoryId"} ],filterFieldMapping: [{lovField:"inventoryId", dsField: "fromInventoryId"} ]} })
		.addLov({name:"fromLocator", xtype:"gridcolumn", dataIndex:"fromLocator", width:150,editor:{xtype:"net.nan21.dnet.module.mm.inventory.lovs.StockLocators" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "fromLocatorId"} ],filterFieldMapping: [{lovField:"subInventoryId", dsField: "fromSubInventoryId"} ]} })
		.addLov({name:"toSubInventory", xtype:"gridcolumn", dataIndex:"toSubInventory", width:150,editor:{xtype:"net.nan21.dnet.module.mm.inventory.lovs.SubInventorys" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "toSubInventoryId"} ],filterFieldMapping: [{lovField:"inventoryId", dsField: "toInventoryId"} ]} })
		.addLov({name:"toLocator", xtype:"gridcolumn", dataIndex:"toLocator", width:150,editor:{xtype:"net.nan21.dnet.module.mm.inventory.lovs.StockLocators" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "toLocatorId"} ],filterFieldMapping: [{lovField:"subInventoryId", dsField: "toSubInventoryId"} ]} })
...
Ext.define("net.nan21.dnet.module.mm.inventory.dc.InvTransactionLine$EditListFrom", {
	extend: "dnet.core.dc.AbstractDcvEditableGrid",
	alias: "widget.net.nan21.dnet.module.mm.inventory.dc.InvTransactionLine$EditListFrom",
	
	_defineColumns_: function () {
		this._getBuilder_()
		.addLov({name:"itemCode", xtype:"gridcolumn", dataIndex:"itemCode", width:150,editor:{xtype:"net.nan21.dnet.module.mm.md.lovs.ProductsWithUom" , selectOnFocus:true ,maxLength:32,retFieldMapping: [{lovField:"id", dsField: "itemId"} ,{lovField:"name", dsField: "item"} ,{lovField:"uomId", dsField: "uomId"} ,{lovField:"uom", dsField: "uom"} ]} })
		.addTextColumn({ name:"item", dataIndex:"item", hidden:true,width:200 })
		.addLov({name:"fromSubInventory", xtype:"gridcolumn", dataIndex:"fromSubInventory", width:150,editor:{xtype:"net.nan21.dnet.module.mm.inventory.lovs.SubInventorys" , selectOnFocus:true,allowBlank:false ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "fromSubInventoryId"} ],filterFieldMapping: [{lovField:"inventoryId", dsField: "fromInventoryId"} ]} })
		.addLov({name:"fromLocator", xtype:"gridcolumn", dataIndex:"fromLocator", width:150,editor:{xtype:"net.nan21.dnet.module.mm.inventory.lovs.StockLocators" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "fromLocatorId"} ],filterFieldMapping: [{lovField:"subInventoryId", dsField: "fromSubInventoryId"} ]} })
		.addNumberColumn({ name:"quantity", dataIndex:"quantity", align:"right",decimals:2,editor:{xtype:"numberfield", selectOnFocus:true , decimalPrecision:2 } })
		.addLov({name:"uom", xtype:"gridcolumn", dataIndex:"uom",width:100,editor:{xtype:"net.nan21.dnet.module.bd.uom.lovs.UnitsOfMeasureCode" , selectOnFocus:true ,maxLength:32,retFieldMapping: [{lovField:"id", dsField: "uomId"} ]} })
		.addNumberColumn({ name:"transactionId", dataIndex:"transactionId", hidden:true, align:"right",format:"0",width:70})
...
Ext.define("net.nan21.dnet.module.mm.inventory.dc.InvTransactionLine$EditListTo", {
	extend: "dnet.core.dc.AbstractDcvEditableGrid",
	alias: "widget.net.nan21.dnet.module.mm.inventory.dc.InvTransactionLine$EditListTo",
