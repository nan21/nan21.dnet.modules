...
Ext.define("net.nan21.dnet.module.mm.md.dc.TestProduct", {
...
Ext.define("net.nan21.dnet.module.mm.md.dc.TestProduct$Filter", {
	extend: "dnet.core.dc.AbstractDcvFilterForm",
 	alias: "widget.net.nan21.dnet.module.mm.md.dc.TestProduct$Filter",
...
Ext.define("net.nan21.dnet.module.mm.md.dc.TestProduct$FilterPG", {
	extend: "dnet.core.dc.AbstractDcvFilterPropGrid",
 	alias: "widget.net.nan21.dnet.module.mm.md.dc.TestProduct$FilterPG",
	_defineElements_: function () {	
		this._getBuilder_()	
		...
		.addLov({ name:"manufacturerCode", dataIndex:"manufacturerCode",editor:{ xtype:"net.nan21.dnet.module.mm.md.lovs.ProductManufacturers", selectOnFocus:true,maxLength:32,retFieldMapping: [{lovField:"id", dsField: "manufacturerId"} ]}  })
		.addTextField({ name:"manufacturerProductNo", dataIndex:"manufacturerProductNo",maxLength:32  })
		.addLov({ name:"attributeGroup", dataIndex:"attributeGroup",editor:{ xtype:"net.nan21.dnet.module.mm.md.lovs.ProductAttributeGroup", selectOnFocus:true,retFieldMapping: [{lovField:"id", dsField: "attributeGroupId"} ]}  })
		.addLov({ name:"productCategory", paramIndex:"productCategory",editor:{ xtype:"net.nan21.dnet.module.mm.md.lovs.ProductCategories", selectOnFocus:true,retFieldMapping: [{lovField:"id", dsParam: "productCategoryId"} ]}  })
...
Ext.define("net.nan21.dnet.module.mm.md.dc.TestProduct$List", {
	extend: "dnet.core.dc.AbstractDcvGrid",
	alias:"widget.net.nan21.dnet.module.mm.md.dc.TestProduct$List",
...
Ext.define("net.nan21.dnet.module.mm.md.dc.TestProduct$EditList", {
	extend: "dnet.core.dc.AbstractDcvEditableGrid",
	alias: "widget.net.nan21.dnet.module.mm.md.dc.TestProduct$EditList",
...
Ext.define("net.nan21.dnet.module.mm.md.dc.TestProduct$Edit", {
	extend: "dnet.core.dc.AbstractDcvEditForm",
	alias: "widget.net.nan21.dnet.module.mm.md.dc.TestProduct$Edit",
...
Ext.define("net.nan21.dnet.module.mm.md.dc.TestProduct$EditPG", {
	extend: "dnet.core.dc.AbstractDcvEditPropGrid",
	alias: "widget.net.nan21.dnet.module.mm.md.dc.TestProduct$EditPG",
