...
net.nan21.dnet.module.mm.md.dc.ProductAttachmentType = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"ProductAttachmentType" 		 
			,ds: new net.nan21.dnet.module.mm.md.ds.ProductAttachmentTypeDs()			  
		});
	 	net.nan21.dnet.module.mm.md.dc.ProductAttachmentType.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.mm.md.dc'); 
net.nan21.dnet.module.mm.md.dc.ProductAttachmentType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.mm.md.dc.ProductAttachmentType$Filter", net.nan21.dnet.module.mm.md.dc.ProductAttachmentType$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.mm.md.dc');	 	 
net.nan21.dnet.module.mm.md.dc.ProductAttachmentType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.mm.md.dc.ProductAttachmentType$EditList", net.nan21.dnet.module.mm.md.dc.ProductAttachmentType$EditList ); 
