...
@Ds(entity = ProductAttachment.class)
public class ProductAttachmentDs extends AbstractDsModel<ProductAttachment>
    ...
    public ProductAttachmentDs(ProductAttachment e) {
        super(e);
    }
