...
@Ds(entity = ProductAttribute.class, sort = { @SortField(field = ProductAttributeDs.fNAME) })
public class ProductAttributeDs extends AbstractDsModel<ProductAttribute>
