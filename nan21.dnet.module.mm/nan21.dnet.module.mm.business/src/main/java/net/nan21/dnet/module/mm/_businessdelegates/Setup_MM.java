package net.nan21.dnet.module.mm._businessdelegates;
...
public class Setup_MM extends AbstractBusinessSetupParticipant implements
		ISetupParticipant {
	...
	private void createTasks() {
		...
		Long i = (Long) this.em.createQuery("select count(e) from Product e")
				.getResultList().get(0);
