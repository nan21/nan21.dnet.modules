...
@Ds(entity = IssueAttachment.class)
public class IssueAttachmentDs extends AbstractDsModel<IssueAttachment>
    ...
    public IssueAttachmentDs() {
        super();
    }

    public IssueAttachmentDs(IssueAttachment e) {
        super(e);
    }
