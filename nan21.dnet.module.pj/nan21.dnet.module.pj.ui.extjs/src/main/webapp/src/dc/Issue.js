...
Ext.define("net.nan21.dnet.module.pj.md.dc.Issue$Edit", {
	...
	_defineElements_: function () {	
		...
		.addLov({ name:"project", xtype:"net.nan21.dnet.module.pj.md.lovs.Projects", dataIndex:"project" ,noUpdate:true ,allowBlank:false, labelSeparator:"*",maxLength:32,retFieldMapping: [{lovField:"id", dsField: "projectId"} ,{lovField:"name", dsField: "projectName"} ]  })
		.addDisplayFieldText({ name:"projectName", dataIndex:"projectName"  })
		.addTextField({ name:"summary", dataIndex:"summary" ,allowBlank:false,maxLength:255  })
		.addDateField({ name:"dueDate", dataIndex:"dueDate" })
		.addDisplayFieldDate({name:"resolutionDate", dataIndex:"resolutionDate"  })
		.addLov({ name:"type", xtype:"net.nan21.dnet.module.pj.base.lovs.IssueTypes", dataIndex:"type" ,allowBlank:false, labelSeparator:"*",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "typeId"} ]  })
		.addLov({ name:"status", xtype:"net.nan21.dnet.module.pj.base.lovs.IssueStatus", dataIndex:"status" ,allowBlank:false, labelSeparator:"*",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "statusId"} ]  })
		.addLov({ name:"priority", xtype:"net.nan21.dnet.module.pj.base.lovs.IssuePriorities", dataIndex:"priority" ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "priorityId"} ]  })
		.addLov({ name:"resolution", xtype:"net.nan21.dnet.module.pj.base.lovs.IssueResolutions", dataIndex:"resolution" ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "resolutionId"} ]  })
		.addLov({ name:"severity", xtype:"net.nan21.dnet.module.pj.base.lovs.IssueSeverities", dataIndex:"severity" ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "severityId"} ]  })
		...
		.addTextField({ name:"assigneeRole", dataIndex:"assigneeRole" ,maxLength:255  })
		.addLov({ name:"reportedVersion", xtype:"net.nan21.dnet.module.pj.md.lovs.ProjectVersionsReleased", dataIndex:"reportedVersion" ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "reportedVersionId"} ],filterFieldMapping: [{lovField:"projectId", dsField: "projectId"} ]  })
		.addLov({ name:"targetVersion", xtype:"net.nan21.dnet.module.pj.md.lovs.ProjectVersionsPlanned", dataIndex:"targetVersion" ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "targetVersionId"} ],filterFieldMapping: [{lovField:"projectId", dsField: "projectId"} ]  })
		.addLov({ name:"fixedInVersion", xtype:"net.nan21.dnet.module.pj.md.lovs.ProjectVersions", dataIndex:"fixedInVersion" ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "fixedInVersionId"} ],filterFieldMapping: [{lovField:"projectId", dsField: "projectId"} ]  })
		.addNumberField({ name:"businessValue", dataIndex:"businessValue"  , style: "text-align:right;" })
		.addNumberField({ name:"estimatedEffort", dataIndex:"estimatedEffort"  , style: "text-align:right;" })
		.addNumberField({ name:"clarity", dataIndex:"clarity"  , style: "text-align:right;" })
		//containers
...
Ext.define("net.nan21.dnet.module.pj.md.dc.Issue$EditText", {
	...
	_defineElements_: function () {	
		//controls	
		this._getBuilder_()	
		.addTextArea({ name:"description", dataIndex:"description",height:250   })
		//containers
