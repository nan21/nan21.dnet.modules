...
Ext.define("net.nan21.dnet.module.pj.md.dc.IssueMnt$EditList", {
	...
	alias: "widget.net.nan21.dnet.module.pj.md.dc.IssueMnt$EditList",
	 ...
	 _noImport_: false
	,_noExport_: false
	,_bulkEditFields_ : ["dueDate","type","status","priority","severity","assignee","reportedVersion","targetVersion","fixedInVersion","resolution"]
	,_defineColumns_: function () {
		...
		.addLov({name:"reportedVersion", xtype:"gridcolumn", dataIndex:"reportedVersion", width:80,editor:{xtype:"net.nan21.dnet.module.pj.md.lovs.ProjectVersions" , selectOnFocus:true,maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "reportedVersionId"} ]} })
		.addLov({name:"targetVersion", xtype:"gridcolumn", dataIndex:"targetVersion", width:80,editor:{xtype:"net.nan21.dnet.module.pj.md.lovs.ProjectVersions" , selectOnFocus:true,maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "targetVersionId"} ]} })
		.addLov({name:"fixedInVersion", xtype:"gridcolumn", dataIndex:"fixedInVersion", width:80,editor:{xtype:"net.nan21.dnet.module.pj.md.lovs.ProjectVersions" , selectOnFocus:true,maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "fixedInVersionId"} ]} })
