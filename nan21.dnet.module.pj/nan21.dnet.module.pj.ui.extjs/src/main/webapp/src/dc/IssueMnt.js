...
Ext.define("net.nan21.dnet.module.pj.md.dc.IssueMnt$EditList", {
	...
	_defineColumns_: function () {
		...
		.addLov({name:"priority", xtype:"gridcolumn", dataIndex:"priority", width:80,editor:{xtype:"net.nan21.dnet.module.pj.base.lovs.IssuePriorities" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "priorityId"} ]} })
		.addLov({name:"severity", xtype:"gridcolumn", dataIndex:"severity", width:80,editor:{xtype:"net.nan21.dnet.module.pj.base.lovs.IssueSeverities" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "severityId"} ]} })
		.addLov({name:"assignee", xtype:"gridcolumn", dataIndex:"assignee", width:80,editor:{xtype:"net.nan21.dnet.module.ad.usr.lovs.Assignables" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "assigneeId"} ]} })
		.addLov({name:"reportedVersion", xtype:"gridcolumn", dataIndex:"reportedVersion", width:80,editor:{xtype:"net.nan21.dnet.module.pj.md.lovs.ProjectVersions" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "reportedVersionId"} ],filterFieldMapping: [{lovField:"projectId", dsField: "projectId"} ]} })
		.addLov({name:"targetVersion", xtype:"gridcolumn", dataIndex:"targetVersion", width:80,editor:{xtype:"net.nan21.dnet.module.pj.md.lovs.ProjectVersions" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "targetVersionId"} ],filterFieldMapping: [{lovField:"projectId", dsField: "projectId"} ]} })
		.addLov({name:"fixedInVersion", xtype:"gridcolumn", dataIndex:"fixedInVersion", width:80,editor:{xtype:"net.nan21.dnet.module.pj.md.lovs.ProjectVersions" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "fixedInVersionId"} ],filterFieldMapping: [{lovField:"projectId", dsField: "projectId"} ]} })
		.addLov({name:"resolution", xtype:"gridcolumn", dataIndex:"resolution", hidden:true, width:80,editor:{xtype:"net.nan21.dnet.module.pj.base.lovs.IssueResolutions" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "resolutionId"} ]} })
