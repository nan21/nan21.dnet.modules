...
Ext.define("net.nan21.dnet.module.pj.md.frame.Issues_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcGridView("issue",{ name:"issueList", xtype:"net.nan21.dnet.module.pj.md.dc.Issue$List"})	 
		...
		.addDcGridView("link",{ name:"linkList", xtype:"net.nan21.dnet.module.pj.md.dc.IssueLink$CtxList",title:"Links"})	 
		...
		.addDcGridView("task",{ name:"taskList", xtype:"net.nan21.dnet.module.pj.md.dc.IssueTaskCtx$List"})	 
