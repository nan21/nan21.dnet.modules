...
Ext.define("net.nan21.dnet.module.pj.base.frame.IssueBaseData_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("categ",{ name:"categFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueCategory$Filter",height:120})	 
		.addDcEditGridView("categ",{ name:"categEditList", xtype:"net.nan21.dnet.module.pj.base.dc.IssueCategory$EditList", frame:true})	 
		.addDcFilterFormView("type",{ name:"typeFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueType$Filter",height:120})	 
		.addDcEditGridView("type",{ name:"typeEditList", xtype:"net.nan21.dnet.module.pj.base.dc.IssueType$EditList", frame:true})	 
		.addDcFilterFormView("status",{ name:"statusFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueStatus$Filter",height:120})	 
		.addDcEditGridView("status",{ name:"statusEditList", xtype:"net.nan21.dnet.module.pj.base.dc.IssueStatus$EditList", frame:true})	 
		.addDcFilterFormView("priority",{ name:"priorityFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssuePriority$Filter",height:120})	 
		.addDcEditGridView("priority",{ name:"priorityEditList", xtype:"net.nan21.dnet.module.pj.base.dc.IssuePriority$EditList", frame:true})	 
		.addDcFilterFormView("severity",{ name:"severityFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueSeverity$Filter",height:120})	 
		.addDcEditGridView("severity",{ name:"severityEditList", xtype:"net.nan21.dnet.module.pj.base.dc.IssueSeverity$EditList", frame:true})	 
		.addDcFilterFormView("resolution",{ name:"resolutionFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueResolution$Filter",height:120})	 
		.addDcEditGridView("resolution",{ name:"resolutionEditList", xtype:"net.nan21.dnet.module.pj.base.dc.IssueResolution$EditList", frame:true})	 
		.addDcFilterFormView("linktype",{ name:"linktypeFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueLinkType$Filter",height:120})	 
		.addDcEditGridView("linktype",{ name:"linktypeEditList", xtype:"net.nan21.dnet.module.pj.base.dc.IssueLinkType$EditList", frame:true})	 
		.addDcFilterFormView("tasktype",{ name:"tasktypeFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueTaskType$Filter",height:120})	 
		.addDcEditGridView("tasktype",{ name:"tasktypeEditList", xtype:"net.nan21.dnet.module.pj.base.dc.IssueTaskType$EditList", frame:true})	 
		.addDcFilterFormView("taskstatus",{ name:"taskstatusFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueTaskStatus$Filter",height:120})	 
		.addDcEditGridView("taskstatus",{ name:"taskstatusEditList", xtype:"net.nan21.dnet.module.pj.base.dc.IssueTaskStatus$EditList", frame:true})	 
