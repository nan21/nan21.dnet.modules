...
Ext.define("net.nan21.dnet.module.pj.base.frame.IssueBaseData_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("categ",{ name:"categFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueCategory$Filter",height:80})	 
		.addDcEditGridView("categ",{ name:"categEditList", xtype:"net.nan21.dnet.module.pj.base.dc.IssueCategory$EditList", frame:true})	 
		.addDcFilterFormView("type",{ name:"typeFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueType$Filter",height:80})	 
		.addDcEditGridView("type",{ name:"typeEditList", xtype:"net.nan21.dnet.module.pj.base.dc.IssueType$EditList", frame:true})	 
		.addDcFilterFormView("status",{ name:"statusFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueStatus$Filter",height:80})	 
		.addDcEditGridView("status",{ name:"statusEditList", xtype:"net.nan21.dnet.module.pj.base.dc.IssueStatus$EditList", frame:true})	 
		.addDcFilterFormView("priority",{ name:"priorityFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssuePriority$Filter",height:80})	 
		...
		.addDcFilterFormView("severity",{ name:"severityFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueSeverity$Filter",height:80})	 
		...
		.addDcFilterFormView("resolution",{ name:"resolutionFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueResolution$Filter",height:80})	 
		...
		.addDcFilterFormView("linktype",{ name:"linktypeFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueLinkType$Filter",height:80})	 
		...
		.addDcFilterFormView("tasktype",{ name:"tasktypeFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueTaskType$Filter",height:80})	 
		...
		.addDcFilterFormView("taskstatus",{ name:"taskstatusFilter", xtype:"net.nan21.dnet.module.pj.base.dc.IssueTaskStatus$Filter",height:80})	 
