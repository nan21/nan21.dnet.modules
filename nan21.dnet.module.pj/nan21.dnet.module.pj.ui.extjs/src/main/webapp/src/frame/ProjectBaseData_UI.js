...
Ext.define("net.nan21.dnet.module.pj.base.frame.ProjectBaseData_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("categ",{ name:"categFilter", xtype:"net.nan21.dnet.module.pj.base.dc.ProjectCategory$Filter",height:40})	 
		.addDcView("categ",{ name:"categEditList", xtype:"net.nan21.dnet.module.pj.base.dc.ProjectCategory$EditList", frame:true})	 
		.addDcFilterFormView("type",{ name:"typeFilter", xtype:"net.nan21.dnet.module.pj.base.dc.ProjectType$Filter",height:40})	 
		.addDcView("type",{ name:"typeEditList", xtype:"net.nan21.dnet.module.pj.base.dc.ProjectType$EditList", frame:true})	 
		.addDcFilterFormView("role",{ name:"roleFilter", xtype:"net.nan21.dnet.module.pj.base.dc.ProjectRole$Filter",height:40})	 
		.addDcView("role",{ name:"roleEditList", xtype:"net.nan21.dnet.module.pj.base.dc.ProjectRole$EditList", frame:true})	 
