...
Ext.define("net.nan21.dnet.module.pj.base.frame.ProjectVersions_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcView("version",{ name:"versionEditList", xtype:"net.nan21.dnet.module.pj.md.dc.ProjectVersion$EditList", frame:true,dockedItems:[{ xtype:"toolbar", ui:"footer", dock: 'bottom', weight:-1, items:[ this._elems_.get("btnRoadmapUi") ,this._elems_.get("btnChangelogUi") ]}]})	 
