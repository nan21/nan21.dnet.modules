...
@NamedQueries({
        @NamedQuery(name = "ItemTextType.findById", query = "SELECT e FROM ItemTextType e WHERE e.id = :pId", hints = @QueryHint(name = QueryHints.BIND_PARAMETERS, value = HintValues.TRUE)),
        @NamedQuery(name = "ItemTextType.findByIds", query = "SELECT e FROM ItemTextType e WHERE e.id in :pIds", hints = @QueryHint(name = QueryHints.BIND_PARAMETERS, value = HintValues.TRUE)),
...
public class ItemTextType implements Serializable, IModelWithId,
     ...
     */
    public static final String NQ_FIND_BY_ID = "ItemTextType.findById";

    /**
     * Named query find by IDs.
     */
    public static final String NQ_FIND_BY_IDS = "ItemTextType.findByIds";
    ...
    public void aboutToUpdate(DescriptorEvent event) {
        ItemTextType e = (ItemTextType) event.getSource();
