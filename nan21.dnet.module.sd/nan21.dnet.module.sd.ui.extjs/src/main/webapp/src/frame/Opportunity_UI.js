...
Ext.define("net.nan21.dnet.module.sd.opportunity.frame.Opportunity_UI", {  
	...
	,_defineDcs_: function() {	
		...
		.addDc("event", new net.nan21.dnet.module.bp.calendar.dc.MyCalendarEvent({}))
		.addDc("note", new net.nan21.dnet.module.ad.data.dc.Note({}))
		.addDc("atch", new net.nan21.dnet.module.sd.opportunity.dc.OpportunityAttachment({multiEdit:true}))		
		.linkDc("event", "opportunity",{fields:[ {childField:"targetId", parentField:"id"},{childField:"targetType", parentField:"className"} ]} )
		.linkDc("note", "opportunity",{fields:[ {childField:"targetId", parentField:"id"},{childField:"targetType", parentField:"className"} ]} )
		.linkDc("atch", "opportunity",{fields:[ {childField:"opportunityId", parentField:"id"} ]} );		
	}	 
	...
	,_defineElements_: function() {							
		...
		.addDcView("atch",{ name:"atchEditList", xtype:"net.nan21.dnet.module.sd.opportunity.dc.OpportunityAttachment$CtxEditList", frame:true,title:"Attachments",dockedItems:[{ xtype:"toolbar", ui:"footer", dock: 'bottom', weight:-1, items:[ this._elems_.get("btnViewAttachment") ,this._elems_.get("btnUploadAttachment") ]}]})	 
		.addDcView("event",{ name:"eventList", xtype:"net.nan21.dnet.module.bp.calendar.dc.MyCalendarEvent$List"})	 
		.addDcFormView("event",{ name:"eventEditCall", xtype:"net.nan21.dnet.module.bp.calendar.dc.MyCalendarEvent$EditCall",title:"Call"})	 
		.addDcFormView("event",{ name:"eventEditMeeting", xtype:"net.nan21.dnet.module.bp.calendar.dc.MyCalendarEvent$EditMeeting",title:"Meeting"})	 
...
this._getWindow_("wdwEventCreate").show();			 	
	...
	,onBtnUploadAttachment: function() {	
		var w=new dnet.base.FileUploadWindow({
    		...
    		_uploadUrl_:"/nan21.dnet.core.web/upload/opportunityAttachmentUpload",
