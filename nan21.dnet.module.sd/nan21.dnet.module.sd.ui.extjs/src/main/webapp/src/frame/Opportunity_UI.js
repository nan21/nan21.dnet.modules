...
Ext.define("net.nan21.dnet.module.sd.opportunity.frame.Opportunity_UI", {  
	...
	,_defineDcs_: function() {	
		...
		.linkDc("atch", "opportunity",{fields:[ {childField:"targetId", parentField:"id"},{childField:"targetType", parentField:"businessObject"} ]} );		
	}	 
	...
	,_defineElements_: function() {							
		...
		.addDcFormView("opportunity",{ name:"opportunityEdit", xtype:"net.nan21.dnet.module.sd.opportunity.dc.Opportunity$Edit"})	 
