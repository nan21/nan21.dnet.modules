...
Ext.define("net.nan21.dnet.module.sd.opportunity.frame.OpportunityBaseData_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("priority",{ name:"priorityFilter", xtype:"net.nan21.dnet.module.sd.opportunity.dc.OpportunityPriority$Filter",height:80})	 
		...
		.addDcFilterFormView("status",{ name:"statusFilter", xtype:"net.nan21.dnet.module.sd.opportunity.dc.OpportunityStatus$Filter",height:80})	 
		...
		.addDcFilterFormView("source",{ name:"sourceFilter", xtype:"net.nan21.dnet.module.sd.opportunity.dc.OpportunitySource$Filter",height:80})	 
		...
		.addDcFilterFormView("stage",{ name:"stageFilter", xtype:"net.nan21.dnet.module.sd.opportunity.dc.OpportunityStage$Filter",height:80})	 
