...
Ext.define("net.nan21.dnet.module.sd.opportunity.frame.OpportunityBaseData_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("priority",{ name:"priorityFilter", xtype:"net.nan21.dnet.module.sd.opportunity.dc.OpportunityPriority$Filter",height:40})	 
		.addDcView("priority",{ name:"priorityEditList", xtype:"net.nan21.dnet.module.sd.opportunity.dc.OpportunityPriority$EditList", frame:true})	 
		.addDcFilterFormView("status",{ name:"statusFilter", xtype:"net.nan21.dnet.module.sd.opportunity.dc.OpportunityStatus$Filter",height:40})	 
		.addDcView("status",{ name:"statusEditList", xtype:"net.nan21.dnet.module.sd.opportunity.dc.OpportunityStatus$EditList", frame:true})	 
		.addDcFilterFormView("source",{ name:"sourceFilter", xtype:"net.nan21.dnet.module.sd.opportunity.dc.OpportunitySource$Filter",height:40})	 
		.addDcView("source",{ name:"sourceEditList", xtype:"net.nan21.dnet.module.sd.opportunity.dc.OpportunitySource$EditList", frame:true})	 
		.addDcFilterFormView("stage",{ name:"stageFilter", xtype:"net.nan21.dnet.module.sd.opportunity.dc.OpportunityStage$Filter",height:40})	 
		.addDcView("stage",{ name:"stageEditList", xtype:"net.nan21.dnet.module.sd.opportunity.dc.OpportunityStage$EditList", frame:true})	 
		.addDcFilterFormView("result",{ name:"resultFilter", xtype:"net.nan21.dnet.module.sd.opportunity.dc.OpportunityResultReason$Filter",height:80})	 
		.addDcView("result",{ name:"resultEditList", xtype:"net.nan21.dnet.module.sd.opportunity.dc.OpportunityResultReason$EditList", frame:true})	 
