...
Ext.define("net.nan21.dnet.module.sd.invoice.frame.SalesInvoice_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcFilterFormView("item",{ name:"itemFilter", xtype:"net.nan21.dnet.module.sd.invoice.dc.SalesInvoiceItem$FilterCtx",width:250,title:"Filter", collapsible:true, collapsed:true})	 
		...
		.addDcGridView("itemTax",{ name:"itemTaxList", xtype:"net.nan21.dnet.module.sd.invoice.dc.SalesInvoiceItemTax$CtxList",width:400,title:"Item taxes", collapsible:true, collapsed:true})	 
		.addDcEditGridView("amount",{ name:"amountList", xtype:"net.nan21.dnet.module.sd.invoice.dc.SalesTxAmount$EditList", frame:true,title:"Payment schedule"})	 
