...
Ext.define("net.nan21.dnet.module.sd.order.frame.SalesOrder_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcFilterFormView("item",{ name:"itemFilter", xtype:"net.nan21.dnet.module.sd.order.dc.SalesOrderItem$FilterCtx",width:250,title:"Filter", collapsible:true, collapsed:true})	 
		...
		.addDcGridView("itemTax",{ name:"itemTaxList", xtype:"net.nan21.dnet.module.sd.order.dc.SalesOrderItemTax$CtxList",width:400,title:"Item taxes", collapsible:true, collapsed:true})	 
