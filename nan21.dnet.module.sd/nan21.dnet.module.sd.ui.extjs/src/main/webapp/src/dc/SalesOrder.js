...
Ext.define("net.nan21.dnet.module.sd.order.dc.SalesOrder$Edit", {
	...
	_defineElements_: function () {	
		...
		.addLov({ name:"status", xtype:"net.nan21.dnet.module.sd.order.lovs.SalesOrderStatus", dataIndex:"status",anchor:"-20" ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "statusId"} ]  })
		.addLov({ name:"type", xtype:"net.nan21.dnet.module.sd.order.lovs.SalesOrderType", dataIndex:"type",anchor:"-20" ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "typeId"} ]  })
		.addTextField({ name:"docNo", dataIndex:"docNo",anchor:"-20" ,allowBlank:false,maxLength:32  })
		.addDateField({ name:"docDate", dataIndex:"docDate",anchor:"-20" ,allowBlank:false})
		.addLov({ name:"priceListName", xtype:"net.nan21.dnet.module.sd.price.lovs.PriceLists", dataIndex:"priceListName",anchor:"-20" ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "priceListId"} ]  })
		...
		.addLov({ name:"deliveryMethod", xtype:"net.nan21.dnet.module.bp.base.lovs.DeliveryMethods", dataIndex:"deliveryMethod",anchor:"-20" ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "deliveryMethodId"} ]  })
		.addLov({ name:"customerCode", xtype:"net.nan21.dnet.module.bp.md.lovs.Customers", dataIndex:"customerCode",anchor:"-20" ,allowBlank:false, labelSeparator:"*",maxLength:32,retFieldMapping: [{lovField:"id", dsField: "customerId"} ,{lovField:"id", dsField: "billToId"} ,{lovField:"code", dsField: "billToCode"} ,{lovField:"id", dsField: "shipToId"} ,{lovField:"code", dsField: "shipToCode"} ]  })
		.addTextField({ name:"supplierCode", dataIndex:"supplierCode",anchor:"-20" ,maxLength:32  })
		.addLov({ name:"billToCode", xtype:"net.nan21.dnet.module.bp.md.lovs.BusinessPartnersCode", dataIndex:"billToCode",anchor:"-20" ,maxLength:32,retFieldMapping: [{lovField:"id", dsField: "billToId"} ]  })
		...
		.addLov({ name:"shipToCode", xtype:"net.nan21.dnet.module.bp.md.lovs.BusinessPartnersCode", dataIndex:"shipToCode",anchor:"-20" ,maxLength:32,retFieldMapping: [{lovField:"id", dsField: "shipToId"} ]  })
