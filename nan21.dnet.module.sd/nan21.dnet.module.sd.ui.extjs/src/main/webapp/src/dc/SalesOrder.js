...
Ext.define("net.nan21.dnet.module.sd.order.dc.SalesOrder$Edit", {
	...
	_defineElements_: function () {	
		...
		.addLov({ name:"billToCode", xtype:"net.nan21.dnet.module.bp.md.lovs.BusinessPartners", dataIndex:"billToCode",anchor:"-20" ,maxLength:32,retFieldMapping: [{lovField:"id", dsField: "billToId"} ]  })
		...
		.addPanel({ name:"col4", layout:"anchor" ,width:250,labelWidth:0 })     
		.addPanel({ name:"main", layout:"hbox", layoutConfig: { align:'top' , pack:'start'}, autoScroll:true }) 
		;     
	}
	,_linkElements_: function () {
