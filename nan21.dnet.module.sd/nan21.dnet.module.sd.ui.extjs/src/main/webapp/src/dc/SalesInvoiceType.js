...
net.nan21.dnet.module.sd.invoice.dc.SalesInvoiceType = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"SalesInvoiceType" 		 
			,ds: new net.nan21.dnet.module.sd.invoice.ds.SalesInvoiceTypeDs()			  
		});
	 	net.nan21.dnet.module.sd.invoice.dc.SalesInvoiceType.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.sd.invoice.dc'); 
net.nan21.dnet.module.sd.invoice.dc.SalesInvoiceType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.sd.invoice.dc.SalesInvoiceType$Filter", net.nan21.dnet.module.sd.invoice.dc.SalesInvoiceType$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.sd.invoice.dc');	 	 
net.nan21.dnet.module.sd.invoice.dc.SalesInvoiceType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.sd.invoice.dc.SalesInvoiceType$EditList", net.nan21.dnet.module.sd.invoice.dc.SalesInvoiceType$EditList ); 
