...
Ext.define("net.nan21.dnet.module.sd.invoice.dc.PaymentIn$Edit", {
	...
	_defineElements_: function () {	
		...
		.addLov({ name:"payFrom", xtype:"net.nan21.dnet.module.md.bp.lovs.CustomersName", dataIndex:"payFrom" ,allowBlank:false, labelSeparator:"*",maxLength:32,retFieldMapping: [{lovField:"id", dsField: "payFromId"} ]  })
		...
		.addLov({ name:"toAccount", xtype:"net.nan21.dnet.module.md.org.lovs.PayAccounts", dataIndex:"toAccount" ,allowBlank:false, labelSeparator:"*",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "toAccountId"} ],filterFieldMapping: [{lovField:"currencyId", dsField: "currencyId"} ,{lovField:"type", dsField: "paymentMethodType"} ]  })
