...
Ext.define("net.nan21.dnet.module.sd.invoice.dc.PaymentIn$Filter", {
	...
	_defineElements_: function () {	
		...
		.addLov({ name:"payFrom", xtype:"net.nan21.dnet.module.md.bp.lovs.BusinessPartnersName", dataIndex:"payFrom",anchor:"-20",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "payFromId"} ]  })
		...
		.addLov({ name:"paymentMethod", xtype:"net.nan21.dnet.module.md.base.tx.lovs.PaymentMethodIn", dataIndex:"paymentMethod",anchor:"-20",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "paymentMethodId"} ]  })
		.addLov({ name:"toAccount", xtype:"net.nan21.dnet.module.md.org.lovs.FinancialAccounts", dataIndex:"toAccount",anchor:"-20",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "toAccountId"} ]  })
...
Ext.define("net.nan21.dnet.module.sd.invoice.dc.PaymentIn$Edit", {
	...
	_defineElements_: function () {	
		...
		.addLov({ name:"payFrom", xtype:"net.nan21.dnet.module.md.bp.lovs.CustomersName", dataIndex:"payFrom" ,allowBlank:false, labelSeparator:"*",maxLength:255,retFieldMapping: [{lovField:"bpartnerId", dsField: "payFromId"} ]  })
		...
		.addLov({ name:"paymentMethod", xtype:"net.nan21.dnet.module.md.base.tx.lovs.PaymentMethodIn", dataIndex:"paymentMethod" ,allowBlank:false, labelSeparator:"*",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "paymentMethodId"} ,{lovField:"type", dsField: "paymentMethodType"} ]  })
		.addLov({ name:"toAccount", xtype:"net.nan21.dnet.module.md.org.lovs.FinancialAccounts", dataIndex:"toAccount" ,allowBlank:false, labelSeparator:"*",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "toAccountId"} ],filterFieldMapping: [{lovField:"currencyId", dsField: "currencyId"} ,{lovField:"type", dsField: "paymentMethodType"} ]  })
