...
net.nan21.dnet.module.sd.order.dc.SalesOrderType = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"SalesOrderType" 		 
			,ds: new net.nan21.dnet.module.sd.order.ds.SalesOrderTypeDs()			  
		});
	 	net.nan21.dnet.module.sd.order.dc.SalesOrderType.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.sd.order.dc'); 
net.nan21.dnet.module.sd.order.dc.SalesOrderType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.sd.order.dc.SalesOrderType$Filter", net.nan21.dnet.module.sd.order.dc.SalesOrderType$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.sd.order.dc');	 	 
net.nan21.dnet.module.sd.order.dc.SalesOrderType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.sd.order.dc.SalesOrderType$EditList", net.nan21.dnet.module.sd.order.dc.SalesOrderType$EditList ); 
