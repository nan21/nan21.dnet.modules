...
Ext.define("net.nan21.dnet.module.sd.order.dc.SalesOrderAttachment", {
	...
	paramModel: "net.nan21.dnet.module.sd.order.ds.param.SalesOrderAttachmentDsParam",
...
Ext.define("net.nan21.dnet.module.sd.order.dc.SalesOrderAttachment$CtxEditList", {
	...
	,_defineColumns_: function () {
		this._getBuilder_()
		.addLov({name:"type", xtype:"gridcolumn", dataIndex:"type",width:120,editor:{xtype:"net.nan21.dnet.module.ad.data.lovs.AttachmentTypes" , selectOnFocus:true,maxLength:255,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "255"},retFieldMapping: [{lovField:"id", dsField: "typeId"} ],filterFieldMapping: [{lovField:"useInContext",value: "SalesOrder"} ]} })
