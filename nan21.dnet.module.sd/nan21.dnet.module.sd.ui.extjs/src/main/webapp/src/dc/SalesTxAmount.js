...
Ext.define("net.nan21.dnet.module.sd.invoice.dc.SalesTxAmount$EditList", {
	...
	_defineColumns_: function () {
		...
		.addLov({name:"paymentMethod", xtype:"gridcolumn", dataIndex:"paymentMethod",width:120,editor:{xtype:"net.nan21.dnet.module.bd.tx.lovs.PaymentMethodIn" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "paymentMethodId"} ]} })
