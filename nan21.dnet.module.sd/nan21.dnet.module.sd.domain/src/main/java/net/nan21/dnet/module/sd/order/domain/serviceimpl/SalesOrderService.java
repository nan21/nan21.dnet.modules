...
import net.nan21.dnet.module.sd.order.domain.service.ISalesOrderService;
...
public class SalesOrderService extends AbstractEntityService<SalesOrder>
    ...
    public List<SalesOrder> findByStatusId(Long statusId) {
        return (List<SalesOrder>) this.em
                .createQuery(
                        "select e from SalesOrder where e.status.id = :pStatusId",
    ...
    public List<SalesOrder> findByTypeId(Long typeId) {
        return (List<SalesOrder>) this.em
                .createQuery(
                        "select e from SalesOrder where e.type.id = :pTypeId",
    ...
    public List<SalesOrder> findByPriceListId(Long priceListId) {
        return (List<SalesOrder>) this.em
                .createQuery(
                        "select e from SalesOrder where e.priceList.id = :pPriceListId",
                        SalesOrder.class)
    ...
    public List<SalesOrder> findByCurrencyId(Long currencyId) {
        return (List<SalesOrder>) this.em
                .createQuery(
                        "select e from SalesOrder where e.currency.id = :pCurrencyId",
                        SalesOrder.class)
    ...
    public List<SalesOrder> findByPaymentMethodId(Long paymentMethodId) {
        return (List<SalesOrder>) this.em
                .createQuery(
                        "select e from SalesOrder where e.paymentMethod.id = :pPaymentMethodId",
                        SalesOrder.class)
    ...
    public List<SalesOrder> findByDeliveryMethodId(Long deliveryMethodId) {
        return (List<SalesOrder>) this.em
                .createQuery(
                        "select e from SalesOrder where e.deliveryMethod.id = :pDeliveryMethodId",
                        SalesOrder.class)
    ...
    public List<SalesOrder> findByCustomerId(Long customerId) {
        return (List<SalesOrder>) this.em
                .createQuery(
                        "select e from SalesOrder where e.customer.id = :pCustomerId",
                        SalesOrder.class)
    ...
    public List<SalesOrder> findBySupplierId(Long supplierId) {
        return (List<SalesOrder>) this.em
                .createQuery(
                        "select e from SalesOrder where e.supplier.id = :pSupplierId",
                        SalesOrder.class)
    ...
    public List<SalesOrder> findByBillToId(Long billToId) {
        return (List<SalesOrder>) this.em
                .createQuery(
                        "select e from SalesOrder where e.billTo.id = :pBillToId",
    ...
    public List<SalesOrder> findByBillToLocationId(Long billToLocationId) {
        return (List<SalesOrder>) this.em
                .createQuery(
                        "select e from SalesOrder where e.billToLocation.id = :pBillToLocationId",
                        SalesOrder.class)
    ...
    public List<SalesOrder> findByShipToId(Long shipToId) {
        return (List<SalesOrder>) this.em
                .createQuery(
                        "select e from SalesOrder where e.shipTo.id = :pShipToId",
    ...
    public List<SalesOrder> findByShipToLocationId(Long shipToLocationId) {
        return (List<SalesOrder>) this.em
                .createQuery(
                        "select e from SalesOrder where e.shipToLocation.id = :pShipToLocationId",
                        SalesOrder.class)
    ...
    public List<SalesOrder> findByLinesId(Long linesId) {
        return (List<SalesOrder>) this.em
                .createQuery(
                        "select e from SalesOrder where e.lines.id = :pLinesId",
