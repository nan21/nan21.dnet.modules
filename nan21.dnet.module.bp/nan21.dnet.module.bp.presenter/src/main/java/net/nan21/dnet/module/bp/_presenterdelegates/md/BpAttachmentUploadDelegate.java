package net.nan21.dnet.module.bp._presenterdelegates.md;
...
public class BpAttachmentUploadDelegate extends AbstractFileUploadService 
implements IFileUploadService {
	...
	public IFileUploadResult execute(String name, MultipartFile file,
		...
		IBpAttachmentService s = (IBpAttachmentService)sl.findEntityService(BpAttachment.class, (List<IEntityServiceFactory>) sl.getAppContext().getBean("osgiEntityServiceFactories"));
		Long id = Long.decode(p1);
		BpAttachment a = s.findById(id);
