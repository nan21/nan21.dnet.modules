package net.nan21.dnet.module.bp._businessdelegates;
...
public class Setup_BP extends AbstractBusinessSetupParticipant implements
		ISetupParticipant {
	...
	private void createTasks() {
		...
		Long i = (Long) this.em.createQuery("select count(e) from Bank e")
				.getResultList().get(0);
