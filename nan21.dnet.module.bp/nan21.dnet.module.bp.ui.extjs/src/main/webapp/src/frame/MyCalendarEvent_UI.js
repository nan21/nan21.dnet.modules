...
Ext.define("net.nan21.dnet.module.bp.calendar.frame.MyCalendarEvent_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcGridView("callEvnt",{ name:"callEvntList", xtype:"net.nan21.dnet.module.bp.calendar.dc.Call$List"})	 
		...
		.addDcGridView("meetingEvnt",{ name:"meetingEvntList", xtype:"net.nan21.dnet.module.bp.calendar.dc.Meeting$List"})	 
		...
		.addDcGridView("taskEvnt",{ name:"taskEvntList", xtype:"net.nan21.dnet.module.bp.calendar.dc.Task$List"})	 
