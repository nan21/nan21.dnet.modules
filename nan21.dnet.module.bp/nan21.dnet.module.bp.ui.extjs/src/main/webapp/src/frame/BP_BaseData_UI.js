...
Ext.define("net.nan21.dnet.module.bp.base.frame.BP_BaseData_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcEditGridView("payMtd",{ name:"payMtdEditList", xtype:"net.nan21.dnet.module.bp.base.dc.PaymentMethod$EditList", frame:true})	 
		.addDcFilterFormView("payTerm",{ name:"payTermFilter", xtype:"net.nan21.dnet.module.bp.base.dc.PaymentTerm$Filter",height:120})	 
		.addDcEditGridView("payTerm",{ name:"payTermEditList", xtype:"net.nan21.dnet.module.bp.base.dc.PaymentTerm$EditList", frame:true})	 
