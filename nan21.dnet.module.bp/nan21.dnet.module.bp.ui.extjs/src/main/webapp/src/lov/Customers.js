...
net.nan21.dnet.module.bp.md.lovs.Customers = Ext.extend( dnet.base.AbstractCombo, {	
	 initComponent : function(){
		...
		this._createStore_(); 
        net.nan21.dnet.module.bp.md.lovs.Customers.superclass.initComponent.call(this);
	}	 
}); 
Ext.reg("net.nan21.dnet.module.bp.md.lovs.Customers", net.nan21.dnet.module.bp.md.lovs.Customers);
