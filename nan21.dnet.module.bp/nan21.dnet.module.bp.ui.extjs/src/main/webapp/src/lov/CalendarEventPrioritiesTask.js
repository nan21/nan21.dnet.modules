...
net.nan21.dnet.module.bp.calendar.lovs.CalendarEventPrioritiesTask = Ext.extend( dnet.base.AbstractCombo, {	
	 initComponent : function(){
		...
		this._createStore_(); 
        net.nan21.dnet.module.bp.calendar.lovs.CalendarEventPrioritiesTask.superclass.initComponent.call(this);
	}	 
}); 
Ext.reg("net.nan21.dnet.module.bp.calendar.lovs.CalendarEventPrioritiesTask", net.nan21.dnet.module.bp.calendar.lovs.CalendarEventPrioritiesTask);
