...
net.nan21.dnet.module.bp.md.lovs.Vendors = Ext.extend( dnet.base.AbstractCombo, {	
	 initComponent : function(){
		...
		this._createStore_(); 
        net.nan21.dnet.module.bp.md.lovs.Vendors.superclass.initComponent.call(this);
	}	 
}); 
Ext.reg("net.nan21.dnet.module.bp.md.lovs.Vendors", net.nan21.dnet.module.bp.md.lovs.Vendors);
