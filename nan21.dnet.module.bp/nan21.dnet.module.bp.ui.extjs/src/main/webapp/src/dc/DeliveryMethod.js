...
net.nan21.dnet.module.bp.base.dc.DeliveryMethod = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"DeliveryMethod" 		 
			,ds: new net.nan21.dnet.module.bp.base.ds.DeliveryMethodDs()			  
		});
	 	net.nan21.dnet.module.bp.base.dc.DeliveryMethod.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.bp.base.dc'); 
net.nan21.dnet.module.bp.base.dc.DeliveryMethod$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.ns('net.nan21.dnet.module.bp.base.dc');	 	 
net.nan21.dnet.module.bp.base.dc.DeliveryMethod$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.bp.base.dc.DeliveryMethod$EditList", net.nan21.dnet.module.bp.base.dc.DeliveryMethod$EditList ); 
