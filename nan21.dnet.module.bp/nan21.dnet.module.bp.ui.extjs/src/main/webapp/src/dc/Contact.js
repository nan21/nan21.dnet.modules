...
Ext.define("net.nan21.dnet.module.bp.md.dc.Contact$CtxEditList", {
	...
	,_defineColumns_: function () {
		...
		.addDateColumn({ name:"birthdate", dataIndex:"birthdate", hidden:true,format:Dnet.DATE_FORMAT,editor:{xtype:"datefield", selectOnFocus:true, format:Dnet.DATE_FORMAT}})
