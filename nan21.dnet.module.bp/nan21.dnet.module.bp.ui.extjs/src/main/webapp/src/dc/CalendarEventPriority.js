...
net.nan21.dnet.module.bp.calendar.dc.CalendarEventPriority = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"CalendarEventPriority" 		 
			,ds: new net.nan21.dnet.module.bp.calendar.ds.CalendarEventPriorityDs()			  
		});
	 	net.nan21.dnet.module.bp.calendar.dc.CalendarEventPriority.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.bp.calendar.dc'); 
net.nan21.dnet.module.bp.calendar.dc.CalendarEventPriority$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.bp.calendar.dc.CalendarEventPriority$Filter", net.nan21.dnet.module.bp.calendar.dc.CalendarEventPriority$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.bp.calendar.dc');	 	 
net.nan21.dnet.module.bp.calendar.dc.CalendarEventPriority$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.bp.calendar.dc.CalendarEventPriority$EditList", net.nan21.dnet.module.bp.calendar.dc.CalendarEventPriority$EditList ); 
