...
net.nan21.dnet.module.bp.base.dc.VendorGroup = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"VendorGroup" 		 
			,ds: new net.nan21.dnet.module.bp.base.ds.VendorGroupDs()			  
		});
	 	net.nan21.dnet.module.bp.base.dc.VendorGroup.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.bp.base.dc'); 
net.nan21.dnet.module.bp.base.dc.VendorGroup$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.bp.base.dc.VendorGroup$Filter", net.nan21.dnet.module.bp.base.dc.VendorGroup$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.bp.base.dc');	 	 
net.nan21.dnet.module.bp.base.dc.VendorGroup$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.bp.base.dc.VendorGroup$EditList", net.nan21.dnet.module.bp.base.dc.VendorGroup$EditList ); 
