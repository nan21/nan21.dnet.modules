...
net.nan21.dnet.module.bp.base.dc.Bank = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"Bank" 		 
			,ds: new net.nan21.dnet.module.bp.base.ds.BankDs()			  
		});
	 	net.nan21.dnet.module.bp.base.dc.Bank.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.bp.base.dc'); 
net.nan21.dnet.module.bp.base.dc.Bank$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
	...
	_defineElements_: function () {	
		...
		this._elems_.add("swiftCode", { name:"swiftCode", xtype:"textfield", dataIndex:"swiftCode", id:Ext.id(),anchor:"-20",maxLength:32,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "32"}  });
		...
		//containers
		this._elems_.add("col1", { name:"col1", layout:"form", id:Ext.id(), width:250, height:50,labelWidth:0 });
	...
	,_linkElements_: function () {
		...
		this._elems_.get("col2")["items"] = [this._elems_.get("swiftCode") ,this._elems_.get("active") ];
	}
}); 
Ext.reg("net.nan21.dnet.module.bp.base.dc.Bank$Filter", net.nan21.dnet.module.bp.base.dc.Bank$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.bp.base.dc');	 	 
net.nan21.dnet.module.bp.base.dc.Bank$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	...
	,_defineColumns_: function () {		
		...
		this._columns_.add("swiftCode", { xtype:"gridcolumn", dataIndex:"swiftCode", sortable:true, hidden:false,width:100,editor:{xtype:"textfield" , selectOnFocus:true,maxLength:32,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "32"},vtype:"alphanum"} });
...
Ext.reg("net.nan21.dnet.module.bp.base.dc.Bank$EditList", net.nan21.dnet.module.bp.base.dc.Bank$EditList ); 
