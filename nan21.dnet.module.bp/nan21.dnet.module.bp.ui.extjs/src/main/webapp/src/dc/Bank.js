...
net.nan21.dnet.module.bp.base.dc.Bank$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
	...
	_defineElements_: function () {	
		...
		//containers
		.addPanel({ name:"col1", layout:"form", width:250, height:50,labelWidth:0 })
...
net.nan21.dnet.module.bp.base.dc.Bank$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	...
	,_defineColumns_: function () {
		...
		.addTextColumn({ name:"swiftCode", dataIndex:"swiftCode",width:100,editor:{xtype:"textfield" , selectOnFocus:true,maxLength:32,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "32"},vtype:"alphanum"} })
