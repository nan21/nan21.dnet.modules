...
net.nan21.dnet.module.bp.base.dc.PaymentMethod = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"PaymentMethod" 		 
			,ds: new net.nan21.dnet.module.bp.base.ds.PaymentMethodDs()			  
		});
	 	net.nan21.dnet.module.bp.base.dc.PaymentMethod.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.bp.base.dc'); 
net.nan21.dnet.module.bp.base.dc.PaymentMethod$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.reg("net.nan21.dnet.module.bp.base.dc.PaymentMethod$Filter", net.nan21.dnet.module.bp.base.dc.PaymentMethod$Filter ); 
 	
Ext.ns('net.nan21.dnet.module.bp.base.dc');	 	 
net.nan21.dnet.module.bp.base.dc.PaymentMethod$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.bp.base.dc.PaymentMethod$EditList", net.nan21.dnet.module.bp.base.dc.PaymentMethod$EditList ); 
