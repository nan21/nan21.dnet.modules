...
Ext.define("net.nan21.dnet.module.sc.invoice.frame.PaymentOut_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcFilterFormView("payment",{ name:"paymentFilter", xtype:"net.nan21.dnet.module.sc.invoice.dc.PaymentOut$Filter",height:130})	 
		.addDcGridView("payment",{ name:"paymentList", xtype:"net.nan21.dnet.module.sc.invoice.dc.PaymentOut$List"})	 
		.addDcFormView("payment",{ name:"paymentEdit", xtype:"net.nan21.dnet.module.sc.invoice.dc.PaymentOut$Edit",height:180,dockedItems:[{ xtype:"toolbar", ui:"footer", dock: 'bottom', weight:-1, items:[ this._elems_.get("btnConfirm") ,this._elems_.get("btnUnConfirm") ,this._elems_.get("btnPost") ,this._elems_.get("btnUnPost") ]}]})	 
