...
Ext.define("net.nan21.dnet.module.sc.invoice.frame.PaymentOut_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("payment",{ name:"paymentFilter", xtype:"net.nan21.dnet.module.sc.invoice.dc.PaymentOut$Filter"})	 
		.addDcGridView("payment",{ name:"paymentList", xtype:"net.nan21.dnet.module.sc.invoice.dc.PaymentOut$List"})	 
		.addDcFormView("payment",{ name:"paymentEdit", xtype:"net.nan21.dnet.module.sc.invoice.dc.PaymentOut$Edit"})	 
