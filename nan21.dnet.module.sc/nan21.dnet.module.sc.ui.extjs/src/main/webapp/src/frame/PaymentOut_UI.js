...
Ext.define("net.nan21.dnet.module.sc.invoice.frame.PaymentOut_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addButton({name:"btnPost",text:"Post", tooltip:"Confirm payment.",iconCls:"icon-action-commit",disabled:true
		...
		.addButton({name:"btnUnPost",text:"Un-Post", tooltip:"Un-Confirm payment.",iconCls:"icon-action-rollback",disabled:true
...
;	 	
	...
	,_linkElements_: function() {
		...
		.addChildrenTo("canvas2",["paymentEdit","paymentDetailsTab"] ,["north","center"])	
	 	.addChildrenTo("paymentDetailsTab", ["accDocPanel"]) 				 		
