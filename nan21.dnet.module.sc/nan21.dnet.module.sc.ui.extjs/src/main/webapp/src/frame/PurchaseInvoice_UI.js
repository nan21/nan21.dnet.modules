...
Ext.define("net.nan21.dnet.module.sc.invoice.frame.PurchaseInvoice_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addButton({name:"btnPostInvoice",text:"Post", tooltip:"Confirm invoice.",iconCls:"icon-action-commit",disabled:true
		...
		.addButton({name:"btnUnPostInvoice",text:"Un-Post", tooltip:"Un-Confirm invoice.",iconCls:"icon-action-rollback",disabled:true
...
;	 	
	...
	,_linkElements_: function() {
		...
		.addChildrenTo("canvas2",["invEdit","invDetailsTab"] ,["north","center"])	
	 	.addChildrenTo("invDetailsTab", ["linesPanel","taxList","accDocPanel","atchEditList","notesPanel"]) 				 		
