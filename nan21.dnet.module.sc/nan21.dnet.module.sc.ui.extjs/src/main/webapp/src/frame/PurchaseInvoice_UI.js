...
Ext.define("net.nan21.dnet.module.sc.invoice.frame.PurchaseInvoice_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcFormView("inv",{ name:"invEdit", xtype:"net.nan21.dnet.module.sc.invoice.dc.PurchaseInvoice$Edit",height:150,dockedItems:[{ xtype:"toolbar", ui:"footer", dock: 'bottom', weight:-1, items:[ this._elems_.get("btnConfirmInvoice") ,this._elems_.get("btnUnConfirmInvoice") ,this._elems_.get("btnPostInvoice") ,this._elems_.get("btnUnPostInvoice") ]}]})	 
