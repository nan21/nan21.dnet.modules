...
Ext.define("net.nan21.dnet.module.sc.invoice.dc.PurchaseInvoiceItem$EditForm", {
	...
	_defineElements_: function () {	
		...
		.addLov({ name:"tax", xtype:"net.nan21.dnet.module.md.base.tax.lovs.TaxApplicables", dataIndex:"tax",anchor:"-20" ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "taxId"} ]  })
		//containers
