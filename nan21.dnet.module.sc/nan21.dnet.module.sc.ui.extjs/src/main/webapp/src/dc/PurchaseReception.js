...
Ext.define("net.nan21.dnet.module.sc.order.dc.PurchaseReception$Edit", {
	...
	_defineElements_: function () {	
		...
		.addLov({ name:"supplier", xtype:"net.nan21.dnet.module.md.bp.lovs.VendorsName", dataIndex:"supplier" ,allowBlank:false, labelSeparator:"*",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "supplierId"} ]  })
