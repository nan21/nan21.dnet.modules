...
Ext.define("net.nan21.dnet.module.sc.invoice.dc.PaymentOut$Edit", {
	...
	_defineElements_: function () {	
		...
		.addLov({ name:"payTo", xtype:"net.nan21.dnet.module.md.bp.lovs.CustomersName", dataIndex:"payTo" ,allowBlank:false, labelSeparator:"*",maxLength:32,retFieldMapping: [{lovField:"id", dsField: "payToId"} ]  })
		...
		.addLov({ name:"fromAccount", xtype:"net.nan21.dnet.module.md.org.lovs.PayAccounts", dataIndex:"fromAccount" ,allowBlank:false, labelSeparator:"*",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "fromAccountId"} ],filterFieldMapping: [{lovField:"currencyId", dsField: "currencyId"} ,{lovField:"type", dsField: "paymentMethodType"} ]  })
