...
Ext.define("net.nan21.dnet.module.sc.order.dc.PurchaseOrder$EditMain", {
	...
	_defineElements_: function () {	
		...
		.addLov({ name:"docType", xtype:"net.nan21.dnet.module.md.base.tx.lovs.TxDocTypesPO", dataIndex:"docType",anchor:"-20" ,allowBlank:false, labelSeparator:"*",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "docTypeId"} ]  })
