...
Ext.define("net.nan21.dnet.module.fi.asset.dc.Asset$Edit", {
	...
	_defineElements_: function () {	
		...
		.addTextField({ name:"org", dataIndex:"org" ,maxLength:32  })
		.addTextField({ name:"category", dataIndex:"category" ,maxLength:32  })
		.addTextField({ name:"productCode", dataIndex:"productCode" ,maxLength:32  })
		.addTextField({ name:"productName", dataIndex:"productName" ,maxLength:255  })
		...
		.addNumberField({ name:"depreciationAmount", dataIndex:"depreciationAmount"  , style: "text-align:right;" })
		//containers
