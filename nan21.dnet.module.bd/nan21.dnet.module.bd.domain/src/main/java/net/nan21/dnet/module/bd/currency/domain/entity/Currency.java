...
@NamedQueries({
        @NamedQuery(name = "Currency.findById", query = "SELECT e FROM Currency e WHERE e.id = :pId", hints = @QueryHint(name = QueryHints.BIND_PARAMETERS, value = HintValues.TRUE)),
        @NamedQuery(name = "Currency.findByIds", query = "SELECT e FROM Currency e WHERE e.id in :pIds", hints = @QueryHint(name = QueryHints.BIND_PARAMETERS, value = HintValues.TRUE)),
...
public class Currency implements Serializable, IModelWithId, IModelWithClientId {
    ...
    public void aboutToUpdate(DescriptorEvent event) {
        ...
        Currency e = (Currency) event.getSource();
