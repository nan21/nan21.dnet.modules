...
@NamedQueries({
        ...
        @NamedQuery(name = "CurrencyXRateProvider.findByIds", query = "SELECT e FROM CurrencyXRateProvider e WHERE e.id in :pIds", hints = @QueryHint(name = QueryHints.BIND_PARAMETERS, value = HintValues.TRUE)),
        @NamedQuery(name = "CurrencyXRateProvider.findByCode", query = "SELECT e FROM CurrencyXRateProvider e WHERE e.clientId = :pClientId and  e.code = :pCode ", hints = @QueryHint(name = QueryHints.BIND_PARAMETERS, value = HintValues.TRUE)),
...
public class CurrencyXRateProvider implements Serializable, IModelWithId,
    ...
    public void aboutToUpdate(DescriptorEvent event) {
        ...
        CurrencyXRateProvider e = (CurrencyXRateProvider) event.getSource();
