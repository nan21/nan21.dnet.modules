...
Ext.define("net.nan21.dnet.module.bd.fin.ds.model.TaxAcctDs" ,{
...
Ext.define("net.nan21.dnet.module.bd.fin.ds.model.TaxAcctDsFilter" ,{
	extend: 'Ext.data.Model',
	fields: [ 
		{name:"id", type:"int", useNull:true},
		{name:"uuid", type:"string"},
...
Ext.define("net.nan21.dnet.module.bd.fin.ds.param.TaxAcctDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
	]
}); 
