 ...
 */   	 
Ext.define("net.nan21.dnet.module.bd.tx.ds.model.FiscalPeriodDs" ,{
...
Ext.define("net.nan21.dnet.module.bd.tx.ds.model.FiscalPeriodDsFilter" ,{
	extend: 'Ext.data.Model',
	fields: [ 
		{name:"name", type:"string"},
		{name:"code", type:"string"},
...
Ext.define("net.nan21.dnet.module.bd.tx.ds.param.FiscalPeriodDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
	]
}); 
