 ...
 */   	 
Ext.define("net.nan21.dnet.module.bd.fin.ds.model.TaxDs" ,{
...
Ext.define("net.nan21.dnet.module.bd.fin.ds.model.TaxDsFilter" ,{
	extend: 'Ext.data.Model',
	fields: [ 
		{name:"name", type:"string"},
...
Ext.define("net.nan21.dnet.module.bd.fin.ds.param.TaxDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
	]
}); 
