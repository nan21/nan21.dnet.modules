...
net.nan21.dnet.module.bd.org.dc.OrganizationHierarchyItem = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"OrganizationHierarchyItem" 		 
			,ds: new net.nan21.dnet.module.bd.org.ds.OrganizationHierarchyItemDs()			  
		});
	 	net.nan21.dnet.module.bd.org.dc.OrganizationHierarchyItem.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.bd.org.dc');	 	 
net.nan21.dnet.module.bd.org.dc.OrganizationHierarchyItem$CtxEditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.bd.org.dc.OrganizationHierarchyItem$CtxEditList", net.nan21.dnet.module.bd.org.dc.OrganizationHierarchyItem$CtxEditList ); 
 	
Ext.ns('net.nan21.dnet.module.bd.org.dc');	 
net.nan21.dnet.module.bd.org.dc.OrganizationHierarchyItem$TreeView = Ext.extend(dnet.base.AbstractDcvTree, {
...
Ext.reg("net.nan21.dnet.module.bd.org.dc.OrganizationHierarchyItem$TreeView", net.nan21.dnet.module.bd.org.dc.OrganizationHierarchyItem$TreeView ); 
