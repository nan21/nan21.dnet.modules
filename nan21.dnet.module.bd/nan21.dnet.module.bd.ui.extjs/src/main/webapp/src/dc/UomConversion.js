...
Ext.define("net.nan21.dnet.module.bd.uom.dc.UomConversion$EditList", {
	...
	,_defineColumns_: function () {
		...
		.addNumberColumn({ name:"multiplyWith", dataIndex:"multiplyWith", align:"right",decimals:2,editor:{xtype:"numberfield", selectOnFocus:true ,decimalPrecision:2 } })
		.addNumberColumn({ name:"divideTo", dataIndex:"divideTo", align:"right",decimals:2,editor:{xtype:"numberfield", selectOnFocus:true ,decimalPrecision:2 } })
