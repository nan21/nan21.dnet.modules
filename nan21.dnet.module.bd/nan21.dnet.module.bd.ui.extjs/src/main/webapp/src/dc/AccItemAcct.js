...
Ext.define("net.nan21.dnet.module.bd.acc.dc.AccItemAcct", {
	extend: "dnet.core.dc.AbstractDc",
 
	recordModel: "net.nan21.dnet.module.bd.acc.ds.model.AccItemAcctDs",
	filterModel: "net.nan21.dnet.module.bd.acc.ds.model.AccItemAcctDsFilter",
	paramModel: "net.nan21.dnet.module.bd.acc.ds.param.AccItemAcctDsParam",
...
Ext.define("net.nan21.dnet.module.bd.acc.dc.AccItemAcct$Filter", {
	extend: "dnet.core.dc.AbstractDcvFilterForm",
 	alias: "widget.net.nan21.dnet.module.bd.acc.dc.AccItemAcct$Filter",
...
Ext.define("net.nan21.dnet.module.bd.acc.dc.AccItemAcct$List", {
	extend: "dnet.core.dc.AbstractDcvGrid",
	alias:"widget.net.nan21.dnet.module.bd.acc.dc.AccItemAcct$List",
...
Ext.define("net.nan21.dnet.module.bd.acc.dc.AccItemAcct$CtxEditList", {
	extend: "dnet.core.dc.AbstractDcvEditableGrid",
	alias: "widget.net.nan21.dnet.module.bd.acc.dc.AccItemAcct$CtxEditList",
	...
	_defineColumns_: function () {
		...
		.addLov({name:"crAccount", xtype:"gridcolumn", dataIndex:"crAccount",width:100,editor:{xtype:"net.nan21.dnet.module.bd.acc.lovs.Accounts" , selectOnFocus:true ,maxLength:32,retFieldMapping: [{lovField:"id", dsField: "crAccountId"} ],filterFieldMapping: [{lovField:"accSchemaId", dsField: "accSchemaId"} ]} })
		.addLov({name:"dbAccount", xtype:"gridcolumn", dataIndex:"dbAccount",width:100,editor:{xtype:"net.nan21.dnet.module.bd.acc.lovs.Accounts" , selectOnFocus:true ,maxLength:32,retFieldMapping: [{lovField:"id", dsField: "dbAccountId"} ],filterFieldMapping: [{lovField:"accSchemaId", dsField: "accSchemaId"} ]} })
