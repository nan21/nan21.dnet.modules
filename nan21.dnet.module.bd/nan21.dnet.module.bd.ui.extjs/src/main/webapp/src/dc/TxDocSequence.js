...
Ext.define("net.nan21.dnet.module.bd.tx.dc.TxDocSequence", {
	extend: "dnet.core.dc.AbstractDc",
 
	recordModel: "net.nan21.dnet.module.bd.tx.ds.model.TxDocSequenceDs",
	filterModel: "net.nan21.dnet.module.bd.tx.ds.model.TxDocSequenceDsFilter",
	paramModel: "net.nan21.dnet.module.bd.tx.ds.param.TxDocSequenceDsParam",
...
Ext.define("net.nan21.dnet.module.bd.tx.dc.TxDocSequence$Filter", {
	extend: "dnet.core.dc.AbstractDcvFilterForm",
 	alias: "widget.net.nan21.dnet.module.bd.tx.dc.TxDocSequence$Filter",
...
Ext.define("net.nan21.dnet.module.bd.tx.dc.TxDocSequence$EditList", {
	extend: "dnet.core.dc.AbstractDcvEditableGrid",
	alias: "widget.net.nan21.dnet.module.bd.tx.dc.TxDocSequence$EditList",
