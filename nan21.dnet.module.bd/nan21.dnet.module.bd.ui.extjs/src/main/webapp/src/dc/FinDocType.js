...
Ext.define("net.nan21.dnet.module.bd.fin.dc.FinDocType$Filter", {
	...
	_defineElements_: function () {	
		...
		.addCombo({ name:"category", xtype:"combo", dataIndex:"category",anchor:"-20",store:[ "SO", "SI", "PO", "PI", "MM"]  })
		//containers
...
Ext.define("net.nan21.dnet.module.bd.fin.dc.FinDocType$EditList", {
	...
	_defineColumns_: function () {
		...
		.addComboColumn({ name:"category", dataIndex:"category", trueText:Dnet.translate("msg", "bool_true"), falseText:Dnet.translate("msg", "bool_false"),editor: {xtype: 'combo', mode: 'local', selectOnFocus:true 	, valueField: 'bv', displayField: 'tv' ,store:[ "SO", "SI", "PO", "PI", "MM"] , triggerAction:'all', forceSelection:true }})
