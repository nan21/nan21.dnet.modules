...
Ext.define("net.nan21.dnet.module.bd.acc.dc.Account", {
	extend: "dnet.core.dc.AbstractDc",
 
	recordModel: "net.nan21.dnet.module.bd.acc.ds.model.AccountDs",
	filterModel: "net.nan21.dnet.module.bd.acc.ds.model.AccountDsFilter",
	paramModel: "net.nan21.dnet.module.bd.acc.ds.param.AccountDsParam",
...
Ext.define("net.nan21.dnet.module.bd.acc.dc.Account$Filter", {
	extend: "dnet.core.dc.AbstractDcvFilterForm",
 	alias: "widget.net.nan21.dnet.module.bd.acc.dc.Account$Filter",
...
Ext.define("net.nan21.dnet.module.bd.acc.dc.Account$List", {
	extend: "dnet.core.dc.AbstractDcvGrid",
	alias:"widget.net.nan21.dnet.module.bd.acc.dc.Account$List",
...
Ext.define("net.nan21.dnet.module.bd.acc.dc.Account$EditList", {
...
Ext.define("net.nan21.dnet.module.bd.acc.dc.Account$Edit", {
	extend: "dnet.core.dc.AbstractDcvEditForm",
	alias: "widget.net.nan21.dnet.module.bd.acc.dc.Account$Edit",
