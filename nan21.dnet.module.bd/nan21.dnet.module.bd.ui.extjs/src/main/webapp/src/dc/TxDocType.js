...
Ext.define("net.nan21.dnet.module.bd.tx.dc.TxDocType", {
	extend: "dnet.core.dc.AbstractDc",
 
	recordModel: "net.nan21.dnet.module.bd.tx.ds.model.TxDocTypeDs",
	filterModel: "net.nan21.dnet.module.bd.tx.ds.model.TxDocTypeDsFilter",
	paramModel: "net.nan21.dnet.module.bd.tx.ds.param.TxDocTypeDsParam",
...
Ext.define("net.nan21.dnet.module.bd.tx.dc.TxDocType$Filter", {
	extend: "dnet.core.dc.AbstractDcvFilterForm",
 	alias: "widget.net.nan21.dnet.module.bd.tx.dc.TxDocType$Filter",
...
Ext.define("net.nan21.dnet.module.bd.tx.dc.TxDocType$EditList", {
	extend: "dnet.core.dc.AbstractDcvEditableGrid",
	alias: "widget.net.nan21.dnet.module.bd.tx.dc.TxDocType$EditList",
	...
	_defineColumns_: function () {
		...
		.addLov({name:"journal", xtype:"gridcolumn", dataIndex:"journal",width:120,editor:{xtype:"net.nan21.dnet.module.bd.acc.lovs.AccJournals" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "journalId"} ]} })
