...
net.nan21.dnet.module.bd.uom.dc.Uom$Edit = Ext.extend(dnet.base.AbstractDcvForm, {
	...
	_defineElements_: function () {	
		...
		this._elems_.add("id", { name:"id", xtype:"numberfield", _rbkey_:"id", dataIndex:"id", id:Ext.id(),anchor:"-20",disabled:true  ,allowBlank:false, labelSeparator:"*" , style: "text-align:right;" });
		this._elems_.add("clientId", { name:"clientId", xtype:"numberfield", _rbkey_:"clientId", dataIndex:"clientId", id:Ext.id(),anchor:"-20" ,allowBlank:false, labelSeparator:"*" , style: "text-align:right;" });
	...
	,_linkElements_: function () {
		...
		this._elems_.get("col2")["items"] = [this._elems_.get("active") ,this._elems_.get("modifiedAt") ,this._elems_.get("modifiedBy") ];
	}	
});
