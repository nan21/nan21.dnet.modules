...
Ext.define("net.nan21.dnet.module.bd.uom.dc.Uom$Edit", {
	...
	_defineElements_: function () {	
		...
		.addLov({ name:"type", xtype:"net.nan21.dnet.module.bd.uom.lovs.UomType", dataIndex:"type" ,allowBlank:false, labelSeparator:"*",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "typeId"} ]  })
		//containers
