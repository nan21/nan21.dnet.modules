...
net.nan21.dnet.module.bd.org.dc.OrganizationType = Ext.extend(dnet.base.AbstractDc, {
	constructor: function(config) {
		config = config || {};
		Ext.apply(config, {
			 dcName:"OrganizationType" 		 
			,ds: new net.nan21.dnet.module.bd.org.ds.OrganizationTypeDs()			  
		});
	 	net.nan21.dnet.module.bd.org.dc.OrganizationType.superclass.constructor.call(this, config);
	}	 
}); 
 	
Ext.ns('net.nan21.dnet.module.bd.org.dc'); 
net.nan21.dnet.module.bd.org.dc.OrganizationType$Filter = Ext.extend(dnet.base.AbstractDcvFilterForm, {
...
Ext.ns('net.nan21.dnet.module.bd.org.dc');	 	 
net.nan21.dnet.module.bd.org.dc.OrganizationType$EditList = Ext.extend(dnet.base.AbstractDcvEditableGrid, {
	 _noImport_: false
	,_noExport_: false
...
Ext.reg("net.nan21.dnet.module.bd.org.dc.OrganizationType$EditList", net.nan21.dnet.module.bd.org.dc.OrganizationType$EditList ); 
