...
Ext.define("net.nan21.dnet.module.bd.standards.dc.ClassificationCode$EditList", {
	...
	,_defineColumns_: function () {
		...
		.addLov({name:"classSystem", xtype:"gridcolumn", dataIndex:"classSystem",width:100,editor:{xtype:"net.nan21.dnet.module.bd.standards.lovs.ClassificationSystems" , selectOnFocus:true,maxLength:32,autoCreate: {tag: "input", type: "text", autocomplete: "off", size: "20", maxlength: "32"},vtype:"alphanum",retFieldMapping: [{lovField:"id", dsField: "classSystemId"} ]} })
