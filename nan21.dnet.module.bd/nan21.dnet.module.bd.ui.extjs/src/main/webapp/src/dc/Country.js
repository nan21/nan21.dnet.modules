...
Ext.define("net.nan21.dnet.module.bd.geo.dc.Country$Edit", {
	...
	_defineElements_: function () {	
		...
		.addTextField({ name:"iso2", dataIndex:"iso2" ,maxLength:2,caseRestriction:"uppercase",vtype:"alphanum"  })
		.addTextField({ name:"iso3", dataIndex:"iso3" ,maxLength:3,caseRestriction:"uppercase",vtype:"alphanum"  })
