...
Ext.define("net.nan21.dnet.module.bd.tx.dc.FiscalPeriod", {
	extend: "dnet.core.dc.AbstractDc",
 
	recordModel: "net.nan21.dnet.module.bd.tx.ds.model.FiscalPeriodDs",
	filterModel: "net.nan21.dnet.module.bd.tx.ds.model.FiscalPeriodDsFilter",
	paramModel: "net.nan21.dnet.module.bd.tx.ds.param.FiscalPeriodDsParam",
...
Ext.define("net.nan21.dnet.module.bd.tx.dc.FiscalPeriod$Filter", {
	extend: "dnet.core.dc.AbstractDcvFilterForm",
 	alias: "widget.net.nan21.dnet.module.bd.tx.dc.FiscalPeriod$Filter",
	_defineElements_: function () {	
		//controls	
		this._getBuilder_()	
		.addTextField({ name:"code",_sharedLabel_:true, dataIndex:"code",anchor:"-20",maxLength:32  })
		.addTextField({ name:"name",_sharedLabel_:true, dataIndex:"name",anchor:"-20",maxLength:255  })
		.addLov({ name:"year", xtype:"net.nan21.dnet.module.bd.tx.lovs.FiscalYears", dataIndex:"year",anchor:"-20",maxLength:32,retFieldMapping: [{lovField:"id", dsField: "yearId"} ]  })
...
Ext.define("net.nan21.dnet.module.bd.tx.dc.FiscalPeriod$List", {
	extend: "dnet.core.dc.AbstractDcvGrid",
	alias:"widget.net.nan21.dnet.module.bd.tx.dc.FiscalPeriod$List",
...
Ext.define("net.nan21.dnet.module.bd.tx.dc.FiscalPeriod$EditList", {
	extend: "dnet.core.dc.AbstractDcvEditableGrid",
	alias: "widget.net.nan21.dnet.module.bd.tx.dc.FiscalPeriod$EditList",
	...
	_defineColumns_: function () {
		...
		.addLov({name:"year", xtype:"gridcolumn", dataIndex:"year",width:100,editor:{xtype:"net.nan21.dnet.module.bd.tx.lovs.FiscalYears" , selectOnFocus:true ,maxLength:32,retFieldMapping: [{lovField:"id", dsField: "yearId"} ]} })
...
Ext.define("net.nan21.dnet.module.bd.tx.dc.FiscalPeriod$Edit", {
	extend: "dnet.core.dc.AbstractDcvEditForm",
	alias: "widget.net.nan21.dnet.module.bd.tx.dc.FiscalPeriod$Edit",
