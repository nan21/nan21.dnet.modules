...
net.nan21.dnet.module.bd.uom.frame.UomConversion_UI = Ext.extend( dnet.base.AbstractUi, {  
	...
	,_defineDcs_: function () {	
		var  m = new net.nan21.dnet.module.bd.uom.dc.UomConversion({multiEdit:true});	 	
	...
	,_defineElements_: function () {
		this._elems_.add("mFilter", { xtype:"net.nan21.dnet.module.bd.uom.dc.UomConversion$Filter", id:Ext.id(), _controller_:this._dcs_.get("m") ,listeners:{ activate:{scope:this,fn:function(){this.doLayout(false,true);} } } });	
		this._elems_.add("mEditList", { xtype:"net.nan21.dnet.module.bd.uom.dc.UomConversion$EditList", frame:true, id:Ext.id(), _controller_:this._dcs_.get("m") ,listeners:{ activate:{scope:this,fn:function(){this.doLayout(false,true);} } } });	
	...
	,_defineToolbars_: function () {
		...
		this._tlbitms_.add("tlbMEditList___TITLE_",  {xtype:"tbtext", text:"UomConversion"} );
