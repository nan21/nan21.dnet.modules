...
Ext.define("net.nan21.dnet.module.bd.uom.frame.UomConversion_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("m",{ name:"mFilter", xtype:"net.nan21.dnet.module.bd.uom.dc.UomConversion$Filter",height:120})	 
		.addDcEditGridView("m",{ name:"mEditList", xtype:"net.nan21.dnet.module.bd.uom.dc.UomConversion$EditList", frame:true})	 
...
;	 	
	...
	,_defineToolbars_: function() {
		this._getBuilder_()
			.beginToolbar("tlbMEditList", {dc:"m"}).addQuery().addSave().addNew().addCopy().addDeleteSelected().addCancel().addReports().addSeparator().addSeparator().addTitle({"text":"UoM conversions"}).end(); 	
	}
