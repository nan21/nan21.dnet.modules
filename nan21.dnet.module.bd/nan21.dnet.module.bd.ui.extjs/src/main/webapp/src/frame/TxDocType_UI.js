...
Ext.define("net.nan21.dnet.module.bd.tx.frame.TxDocType_UI", {  
	...
	alias:"widget.net.nan21.dnet.module.bd.tx.frame.TxDocType_UI",
	
	 _name_ : "net.nan21.dnet.module.bd.tx.frame.TxDocType_UI"
	,_defineDcs_: function() {	
		this._getBuilder_()
		.addDc("docType", new net.nan21.dnet.module.bd.tx.dc.TxDocType({multiEdit:true}))
		.addDc("seq", new net.nan21.dnet.module.bd.tx.dc.TxDocSequence({multiEdit:true}))		;		
	}	 

	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("docType",{ name:"docTypeFilter", xtype:"net.nan21.dnet.module.bd.tx.dc.TxDocType$Filter",height:120})	 
		.addDcEditGridView("docType",{ name:"docTypeEditList", xtype:"net.nan21.dnet.module.bd.tx.dc.TxDocType$EditList", frame:true})	 
		.addDcFilterFormView("seq",{ name:"seqFilter", xtype:"net.nan21.dnet.module.bd.tx.dc.TxDocSequence$Filter"})	 
		.addDcEditGridView("seq",{ name:"seqEditList", xtype:"net.nan21.dnet.module.bd.tx.dc.TxDocSequence$EditList", frame:true})	 
