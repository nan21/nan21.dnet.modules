...
Ext.define("net.nan21.dnet.module.bd.elem.frame.Element_UI", {  
	...
	,_defineDcs_: function() {	
		...
		.linkDc("formula", "elem",{fields:[ {childField:"elementId", parentField:"id"} ]} );		
	}	 

	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("elem",{ name:"elemFilter", xtype:"net.nan21.dnet.module.bd.elem.dc.Element$Filter",height:80})	 
		.addDcGridView("elem",{ name:"elemList", xtype:"net.nan21.dnet.module.bd.elem.dc.Element$List"})	 
		.addDcGridView("input",{ name:"inputList", xtype:"net.nan21.dnet.module.bd.elem.dc.ElementInput$CtxList",title:"Input values"})	 
		.addDcGridView("formula",{ name:"formulaList", xtype:"net.nan21.dnet.module.bd.elem.dc.ElementFormula$CtxList",width:300})	 
		.addDcFormView("formula",{ name:"formulaEdit", xtype:"net.nan21.dnet.module.bd.elem.dc.ElementFormula$ViewExpression"})	 
		.addPanel({name: "main",layout:"card", activeItem:0})  	 

		.addPanel({name: "detailsTab", xtype:"tabpanel", activeTab:0, plain:false, deferredRender:false, id:Ext.id(),height:220}) 	 
