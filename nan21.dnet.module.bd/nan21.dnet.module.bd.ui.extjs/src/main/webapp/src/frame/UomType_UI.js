...
Ext.define("net.nan21.dnet.module.bd.uom.frame.UomType_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcEditGridView("type",{ name:"typeEditList", xtype:"net.nan21.dnet.module.bd.uom.dc.UomType$EditList", frame:true})	 
...
;	 	
	...
	,_defineToolbars_: function() {
		this._getBuilder_()
			.beginToolbar("tlbTypeEditList", {dc:"type"}).addQuery().addSave().addNew().addCopy().addDeleteSelected().addCancel().addReports().addSeparator().addSeparator().addTitle({"text":"UoM types"}).end(); 	
	}
