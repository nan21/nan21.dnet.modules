...
Ext.define("net.nan21.dnet.module.bd.uom.frame.Uoms_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("m",{ name:"mFilter", xtype:"net.nan21.dnet.module.bd.uom.dc.Uom$Filter",height:80})	 
		.addDcEditGridView("m",{ name:"mEditList", xtype:"net.nan21.dnet.module.bd.uom.dc.Uom$EditList", frame:true})	 
...
;	 	
	...
	,_defineToolbars_: function() {
		this._getBuilder_()
			.beginToolbar("tlbMEditList", {dc:"m"}).addQuery().addSave().addNew().addCopy().addDeleteSelected().addCancel().addReports().addSeparator().addSeparator().addTitle({"text":"Units of measure"}).end(); 	
	}
