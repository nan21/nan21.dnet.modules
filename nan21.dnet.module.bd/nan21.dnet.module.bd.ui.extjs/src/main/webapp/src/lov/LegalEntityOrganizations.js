...
net.nan21.dnet.module.bd.org.lovs.LegalEntityOrganizations = Ext.extend( dnet.base.AbstractCombo, {	
	 initComponent : function(){
		...
		this._createStore_(); 
        net.nan21.dnet.module.bd.org.lovs.LegalEntityOrganizations.superclass.initComponent.call(this);
	}	 
}); 
Ext.reg("net.nan21.dnet.module.bd.org.lovs.LegalEntityOrganizations", net.nan21.dnet.module.bd.org.lovs.LegalEntityOrganizations);
