 ...
 */
package net.nan21.dnet.module.md.asset.business.serviceimpl;

import net.nan21.dnet.core.api.session.Session;
import net.nan21.dnet.core.business.service.AbstractEntityService;
import net.nan21.dnet.module.md.asset.business.service.IAssetCategoryService;

import javax.persistence.EntityManager;
import net.nan21.dnet.module.md.asset.domain.entity.AssetCategory;
