...
Ext.define("net.nan21.dnet.module.md.mm.prod.frame.Product_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcGridView("stock",{ name:"stockList", xtype:"net.nan21.dnet.module.md.tx.inventory.dc.InvBalance$CtxListProduct",title:"Stocks"})	 
...
;	 	
	...
	,_linkElements_: function() {
		...
		.addChildrenTo("canvas2",["prodEdit","prodDetailsTab"] ,["north","center"])	
	 	.addChildrenTo("prodDetailsTab", ["prodEditInfo","accountsPanel","attrEditList","classificEdit","atchEditList","notesPanel","stockList"]) 				 		
