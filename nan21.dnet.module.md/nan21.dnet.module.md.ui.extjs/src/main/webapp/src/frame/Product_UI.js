...
Ext.define("net.nan21.dnet.module.md.mm.prod.frame.Product_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcFilterFormView("attr",{ name:"attrFilter", xtype:"net.nan21.dnet.module.md.mm.prod.dc.ProductAttributeValue$FilterCtx",width:250,title:"Filter", collapsible:true})	 
		.addDcEditGridView("attr",{ name:"attrEditList", xtype:"net.nan21.dnet.module.md.mm.prod.dc.ProductAttributeValue$CtxEditList", frame:true})	 
		...
		.addPanel({name: "attrPanel", layout:"border", defaults:{split:true},title:"Attributes"})  	 
