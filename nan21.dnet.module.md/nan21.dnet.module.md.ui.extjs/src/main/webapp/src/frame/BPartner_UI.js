...
Ext.define("net.nan21.dnet.module.md.bp.frame.BPartner_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcFormView("account",{ name:"accountEdit", xtype:"net.nan21.dnet.module.md.bp.dc.BpAccount$EditCtx"})	 
...
;	 	
	...
	,_linkElements_: function() {
		...
		.addChildrenTo("canvas2",["bpEdit","bpDetailsTab"] ,["north","center"])	
	 	.addChildrenTo("bpDetailsTab", ["accountPanel","bpPhoneEditList","addressPanel","bpContactEditList","bpBankAccountEditList","classificEdit","atchEditList","notesPanel"]) 				 		
		.addChildrenTo("notesPanel",["noteList","noteEdit"] ,["west","center"])	
	 	...
	 	.addChildrenTo("accountPanel", ["accountList","accountEditWrapper"]) 				 		
