...
Ext.define("net.nan21.dnet.module.md.bp.frame.BPartner_UI", {  
	...
	,_defineDcs_: function() {	
		...
		.addDc("balance", new net.nan21.dnet.module.md.bp.dc.BpBalance({}))
	...
	,_defineElements_: function() {							
		...
		.addDcGridView("balance",{ name:"balanceList", xtype:"net.nan21.dnet.module.md.bp.dc.BpBalance$CtxList",title:"Balance"})	 
