...
Ext.define("net.nan21.dnet.module.md.acc.frame.AccItem_UI", {  
	...
	,_defineElements_: function() {							
		...
		.addDcEditGridView("item",{ name:"itemEditList", xtype:"net.nan21.dnet.module.md.acc.dc.AccItem$EditList", frame:true,width:500})	 
		.addDcEditGridView("acct",{ name:"acctEditList", xtype:"net.nan21.dnet.module.md.acc.dc.AccItemAcct$CtxEditList", frame:true})	 
...
;	 	
	...
	,_defineToolbars_: function() {
		this._getBuilder_()
			.beginToolbar("tlbItemList", {dc:"item"}).addQuery().addSave().addNew().addCopy().addDeleteSelected().addCancel().addReports().addSeparator().addSeparator().addTitle({"text":"G/L Items"}).end()
