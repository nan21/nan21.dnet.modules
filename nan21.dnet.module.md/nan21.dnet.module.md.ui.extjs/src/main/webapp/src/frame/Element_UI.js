Dnet.doImport(["", "nan21.dnet.module.md.ui.extjs/ds/ElementDs", "nan21.dnet.module.md.ui.extjs/dc/Element", "nan21.dnet.module.md.ui.extjs/ds/ElementInputDs", "nan21.dnet.module.md.ui.extjs/dc/ElementInput", "nan21.dnet.module.md.ui.extjs/ds/ElementFormulaDs", "nan21.dnet.module.md.ui.extjs/dc/ElementFormula","nan21.dnet.module.md.ui.extjs/ds/ElementTypeLovDs","nan21.dnet.module.md.ui.extjs/lov/ElementTypes","nan21.dnet.module.md.ui.extjs/ds/ElementTypeLovDs","nan21.dnet.module.md.ui.extjs/lov/ElementTypes","nan21.dnet.module.md.ui.extjs/ds/ElementLovDs","nan21.dnet.module.md.ui.extjs/lov/ElementsCode"]);

Ext.define("net.nan21.dnet.module.md.base.elem.frame.Element_UI", {  
	extend: "dnet.core.ui.AbstractUi",
	alias:"widget.net.nan21.dnet.module.md.base.elem.frame.Element_UI",
	
	 _name_ : "net.nan21.dnet.module.md.base.elem.frame.Element_UI"
	,_defineDcs_: function() {	
		this._getBuilder_()
		.addDc("elem", new net.nan21.dnet.module.md.base.elem.dc.Element({}))
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("elem",{ name:"elemFilter", xtype:"net.nan21.dnet.module.md.base.elem.dc.Element$Filter",height:120})	 
		.addDcGridView("elem",{ name:"elemList", xtype:"net.nan21.dnet.module.md.base.elem.dc.Element$List"})	 
		.addDcFormView("elem",{ name:"elemEdit", xtype:"net.nan21.dnet.module.md.base.elem.dc.Element$Edit",height:150})	 
		.addDcEditGridView("input",{ name:"inputEditList", xtype:"net.nan21.dnet.module.md.base.elem.dc.ElementInput$CtxEditList", frame:true,title:"Input values"})	 
		.addDcEditGridView("formula",{ name:"formulaList", xtype:"net.nan21.dnet.module.md.base.elem.dc.ElementFormula$CtxEditList", frame:true,width:300})	 
		.addDcFormView("formula",{ name:"formulaEdit", xtype:"net.nan21.dnet.module.md.base.elem.dc.ElementFormula$EditExpression"})	 
