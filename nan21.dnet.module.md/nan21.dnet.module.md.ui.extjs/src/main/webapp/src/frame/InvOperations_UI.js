...
Ext.define("net.nan21.dnet.module.md.tx.inventory.frame.InvOperations_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("invop",{ name:"invopFilter", xtype:"net.nan21.dnet.module.md.tx.inventory.dc.InvOperation$Filter",height:140})	 
		.addDcGridView("invop",{ name:"invopList", xtype:"net.nan21.dnet.module.md.tx.inventory.dc.InvOperation$List"})	 
