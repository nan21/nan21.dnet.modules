...
Ext.define("net.nan21.dnet.module.md.base.tx.frame.TxBaseData_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("payMtd",{ name:"payMtdFilter", xtype:"net.nan21.dnet.module.md.base.tx.dc.PaymentMethod$Filter",height:120})	 
		.addDcEditGridView("payMtd",{ name:"payMtdEditList", xtype:"net.nan21.dnet.module.md.base.tx.dc.PaymentMethod$EditList", frame:true})	 
		.addDcFilterFormView("payTerm",{ name:"payTermFilter", xtype:"net.nan21.dnet.module.md.base.tx.dc.PaymentTerm$Filter",height:120})	 
		.addDcEditGridView("payTerm",{ name:"payTermEditList", xtype:"net.nan21.dnet.module.md.base.tx.dc.PaymentTerm$EditList", frame:true})	 
		.addDcFilterFormView("delivMtd",{ name:"delivMtdFilter", xtype:"net.nan21.dnet.module.md.base.tx.dc.DeliveryMethod$Filter",height:120})	 
