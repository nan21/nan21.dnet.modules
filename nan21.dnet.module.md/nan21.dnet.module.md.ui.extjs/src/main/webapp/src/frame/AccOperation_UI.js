...
Ext.define("net.nan21.dnet.module.md.tx.acc.frame.AccOperation_UI", {  
	...
	,_defineElements_: function() {							
		this._getBuilder_()	
		.addDcFilterFormView("op",{ name:"opFilter", xtype:"net.nan21.dnet.module.md.tx.acc.dc.AccOperation$Filter"})	 
		.addDcGridView("op",{ name:"opList", xtype:"net.nan21.dnet.module.md.tx.acc.dc.AccOperation$List"})	 
