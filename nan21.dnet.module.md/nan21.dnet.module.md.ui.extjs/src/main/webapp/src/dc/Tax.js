...
Ext.define("net.nan21.dnet.module.md.base.tax.dc.Tax$Filter", {
	extend: "dnet.core.dc.AbstractDcvFilterForm",
 	alias: "widget.net.nan21.dnet.module.md.base.tax.dc.Tax$Filter",
	_defineElements_: function () {	
		...
		.addLov({ name:"parentTax", xtype:"net.nan21.dnet.module.md.base.tax.lovs.Taxes", dataIndex:"parentTax",anchor:"-20",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "parentTaxId"} ]  })
		//containers
...
Ext.define("net.nan21.dnet.module.md.base.tax.dc.Tax$List", {
	...
	alias:"widget.net.nan21.dnet.module.md.base.tax.dc.Tax$List",
...
Ext.define("net.nan21.dnet.module.md.base.tax.dc.Tax$Edit", {
	...
	alias: "widget.net.nan21.dnet.module.md.base.tax.dc.Tax$Edit",
