...
Ext.define("net.nan21.dnet.module.md.mm.prod.dc.ProductAttribute$Filter", {
	...
	_defineElements_: function () {	
		...
		.addLov({ name:"type", xtype:"net.nan21.dnet.module.md.mm.prod.lovs.ProductAttributeType", dataIndex:"type",anchor:"-20",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "typeId"} ]  })
...
Ext.define("net.nan21.dnet.module.md.mm.prod.dc.ProductAttribute$EditList", {
	...
	_defineColumns_: function () {
		...
		.addLov({name:"type", xtype:"gridcolumn", dataIndex:"type",width:120,editor:{xtype:"net.nan21.dnet.module.md.mm.prod.lovs.ProductAttributeType" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "typeId"} ]} })
