...
Ext.define("net.nan21.dnet.module.md.bp.dc.BpBankAccount$CtxEditList", {
	...
	alias: "widget.net.nan21.dnet.module.md.bp.dc.BpBankAccount$CtxEditList",
	...
	_defineColumns_: function () {
		...
		.addLov({name:"bankCode", xtype:"gridcolumn", dataIndex:"bankCode",width:100,editor:{xtype:"net.nan21.dnet.module.md.bp.lovs.Banks" , selectOnFocus:true ,maxLength:32,retFieldMapping: [{lovField:"id", dsField: "bankId"} ]} })
