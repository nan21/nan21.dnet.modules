...
Ext.define("net.nan21.dnet.module.md.org.dc.StockLocator$Filter", {
	extend: "dnet.core.dc.AbstractDcvFilterForm",
 	alias: "widget.net.nan21.dnet.module.md.org.dc.StockLocator$Filter",
	_defineElements_: function () {	
		...
		.addLov({ name:"locatorType", xtype:"net.nan21.dnet.module.md.org.lovs.StockLocatorTypes", dataIndex:"locatorType",anchor:"-20",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "locatorTypeId"} ]  })
		//containers
...
Ext.define("net.nan21.dnet.module.md.org.dc.StockLocator$CtxEditList", {
	...
	alias: "widget.net.nan21.dnet.module.md.org.dc.StockLocator$CtxEditList",
	
	_defineColumns_: function () {
		this._getBuilder_()
		.addTextColumn({ name:"name", dataIndex:"name",width:120,editor:{xtype:"textfield", selectOnFocus:true } })
		.addTextColumn({ name:"description", dataIndex:"description",width:200,editor:{xtype:"textfield", selectOnFocus:true } })
		.addLov({name:"locatorType", xtype:"gridcolumn", dataIndex:"locatorType",width:120,editor:{xtype:"net.nan21.dnet.module.md.org.lovs.StockLocatorTypes" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "locatorTypeId"} ]} })
