...
Ext.define("net.nan21.dnet.module.md.activity.dc.CalendarEventPriority$Filter", {
	extend: "dnet.core.dc.AbstractDcvFilterForm",
 	alias: "widget.net.nan21.dnet.module.md.activity.dc.CalendarEventPriority$Filter",
...
Ext.define("net.nan21.dnet.module.md.activity.dc.CalendarEventPriority$EditList", {
	...
	alias: "widget.net.nan21.dnet.module.md.activity.dc.CalendarEventPriority$EditList",
