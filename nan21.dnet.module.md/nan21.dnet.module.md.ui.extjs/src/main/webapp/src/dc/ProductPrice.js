...
Ext.define("net.nan21.dnet.module.md.mm.price.dc.ProductPrice$FilterCtx", {
	extend: "dnet.core.dc.AbstractDcvFilterPropGrid",
 	alias: "widget.net.nan21.dnet.module.md.mm.price.dc.ProductPrice$FilterCtx",
	_defineElements_: function () {	
		this._getBuilder_()	
		.addLov({ name:"product", dataIndex:"product",editor:{ xtype:"net.nan21.dnet.module.md.mm.prod.lovs.Products", selectOnFocus:true,maxLength:32,retFieldMapping: [{lovField:"id", dsField: "productId"} ]}  })
		.addNumberField({ name:"price", dataIndex:"price"  })
		...
		.addLov({ name:"uom", dataIndex:"uom",editor:{ xtype:"net.nan21.dnet.module.bd.uom.lovs.UnitsOfMeasureCode", selectOnFocus:true,maxLength:32,retFieldMapping: [{lovField:"id", dsField: "uomId"} ]}  })
