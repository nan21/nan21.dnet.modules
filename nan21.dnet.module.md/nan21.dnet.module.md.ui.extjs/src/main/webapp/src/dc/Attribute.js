...
Ext.define("net.nan21.dnet.module.md.base.attr.dc.Attribute", {
	extend: "dnet.core.dc.AbstractDc",
 
	recordModel: "net.nan21.dnet.module.md.base.attr.ds.model.AttributeDs",
	filterModel: "net.nan21.dnet.module.md.base.attr.ds.model.AttributeDsFilter",
	paramModel: "net.nan21.dnet.module.md.base.attr.ds.param.AttributeDsParam",
...
Ext.define("net.nan21.dnet.module.md.base.attr.dc.Attribute$Filter", {
	extend: "dnet.core.dc.AbstractDcvFilterForm",
 	alias: "widget.net.nan21.dnet.module.md.base.attr.dc.Attribute$Filter",
...
Ext.define("net.nan21.dnet.module.md.base.attr.dc.Attribute$EditList", {
	extend: "dnet.core.dc.AbstractDcvEditableGrid",
	alias: "widget.net.nan21.dnet.module.md.base.attr.dc.Attribute$EditList",
	...
	_defineColumns_: function () {
		...
		.addLov({name:"type", xtype:"gridcolumn", dataIndex:"type",width:120,editor:{xtype:"net.nan21.dnet.module.md.base.attr.lovs.AttributeType" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "typeId"} ]} })
