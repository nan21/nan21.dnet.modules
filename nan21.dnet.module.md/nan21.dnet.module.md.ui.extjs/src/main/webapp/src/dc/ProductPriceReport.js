...
Ext.define("net.nan21.dnet.module.md.mm.price.dc.ProductPriceReport$Filter", {
	extend: "dnet.core.dc.AbstractDcvFilterForm",
 	alias: "widget.net.nan21.dnet.module.md.mm.price.dc.ProductPriceReport$Filter",
	_defineElements_: function () {	
		...
		.addLov({ name:"priceListVersion", xtype:"net.nan21.dnet.module.md.mm.price.lovs.PriceListVersion", dataIndex:"priceListVersion",anchor:"-20",maxLength:255,retFieldMapping: [{lovField:"id", dsField: "priceListVersionId"} ],filterFieldMapping: [{lovField:"priceListId", dsField: "priceListId"} ]  })
...
Ext.define("net.nan21.dnet.module.md.mm.price.dc.ProductPriceReport$List", {
	...
	alias:"widget.net.nan21.dnet.module.md.mm.price.dc.ProductPriceReport$List",
