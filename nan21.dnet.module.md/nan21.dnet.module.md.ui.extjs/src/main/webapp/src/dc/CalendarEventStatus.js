...
Ext.define("net.nan21.dnet.module.md.activity.dc.CalendarEventStatus$Filter", {
	extend: "dnet.core.dc.AbstractDcvFilterForm",
 	alias: "widget.net.nan21.dnet.module.md.activity.dc.CalendarEventStatus$Filter",
...
Ext.define("net.nan21.dnet.module.md.activity.dc.CalendarEventStatus$EditList", {
	...
	alias: "widget.net.nan21.dnet.module.md.activity.dc.CalendarEventStatus$EditList",
