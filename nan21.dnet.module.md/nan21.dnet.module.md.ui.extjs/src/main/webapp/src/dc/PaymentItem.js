...
Ext.define("net.nan21.dnet.module.md.tx.fin.dc.PaymentItem$CtxEditListAccItem", {
	...
	_defineColumns_: function () {
		this._getBuilder_()
		.addLov({name:"accItem", xtype:"gridcolumn", dataIndex:"accItem",width:120,editor:{xtype:"net.nan21.dnet.module.bd.acc.lovs.AccItems" , selectOnFocus:true ,maxLength:255,retFieldMapping: [{lovField:"id", dsField: "accItemId"} ]} })
