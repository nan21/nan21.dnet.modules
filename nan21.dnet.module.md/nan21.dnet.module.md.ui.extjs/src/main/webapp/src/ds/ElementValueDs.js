 ...
 */   	 
Ext.define("net.nan21.dnet.module.md.base.elem.ds.model.ElementValueDs" ,{
...
Ext.define("net.nan21.dnet.module.md.base.elem.ds.model.ElementValueDsFilter" ,{
	extend: 'Ext.data.Model',
	fields: [ 
		{name:"id", type:"int", useNull:true},
		{name:"uuid", type:"string"},
...
Ext.define("net.nan21.dnet.module.md.base.elem.ds.param.ElementValueDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
	]
}); 
