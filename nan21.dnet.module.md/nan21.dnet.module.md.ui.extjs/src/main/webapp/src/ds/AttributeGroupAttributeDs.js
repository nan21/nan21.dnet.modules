 ...
 */   	 
Ext.define("net.nan21.dnet.module.md.base.attr.ds.model.AttributeGroupAttributeDs" ,{
...
Ext.define("net.nan21.dnet.module.md.base.attr.ds.model.AttributeGroupAttributeDsFilter" ,{
	extend: 'Ext.data.Model',
	fields: [ 
		{name:"id", type:"int", useNull:true},
		{name:"uuid", type:"string"},
...
Ext.define("net.nan21.dnet.module.md.base.attr.ds.param.AttributeGroupAttributeDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
	]
}); 
