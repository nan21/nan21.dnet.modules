 ...
 */   	 
Ext.define("net.nan21.dnet.module.md.bp.ds.model.BpBalanceDs" ,{
...
Ext.define("net.nan21.dnet.module.md.bp.ds.model.BpBalanceDsFilter" ,{
	extend: 'Ext.data.Model',
	fields: [ 
		{name:"id", type:"int", useNull:true},
		{name:"uuid", type:"string"},
...
Ext.define("net.nan21.dnet.module.md.bp.ds.param.BpBalanceDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
	]
}); 
