 ...
 */   	 
Ext.define("net.nan21.dnet.module.md.base.elem.ds.model.ElementFormulaDs" ,{
...
Ext.define("net.nan21.dnet.module.md.base.elem.ds.model.ElementFormulaDsFilter" ,{
	extend: 'Ext.data.Model',
	fields: [ 
		{name:"id", type:"int", useNull:true},
		{name:"uuid", type:"string"},
...
Ext.define("net.nan21.dnet.module.md.base.elem.ds.param.ElementFormulaDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
	]
}); 
