 ...
 */   	 
Ext.define("net.nan21.dnet.module.md.base.elem.ds.model.ElementInputDs" ,{
...
Ext.define("net.nan21.dnet.module.md.base.elem.ds.model.ElementInputDsFilter" ,{
	extend: 'Ext.data.Model',
	fields: [ 
		{name:"id", type:"int", useNull:true},
		{name:"uuid", type:"string"},
...
Ext.define("net.nan21.dnet.module.md.base.elem.ds.param.ElementInputDsParam", {
	extend: 'Ext.data.Model',
	fields: [ 
	]
}); 
